					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Oscarverleihung 2023",
									"targetURL": "#s321502-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"s321502-display": {
								"semanticObject": "s321502",
								"action": "display",
								"description": "Übersicht über die Oscars 2023",
								"title": "Oscarverleihung 2023",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=s321502",
									"url": sap.ui.require.toUrl("s321502")
								}
							}
						}
					}
