			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"s330401-display": {
								"semanticObject": "s330401",
								"action": "display",
								"description": "Übung zu 04-01",
								"title": "Titel",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=s330401",
									"url": sap.ui.require.toUrl("s330401")
								}
							}
						}
					}
