					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Irgendwelche Übung 1401",
									"targetURL": "#s321401-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"s321401-display": {
								"semanticObject": "s321401",
								"action": "display",
								"description": "Übung JSON Modell",
								"title": "Irgendwelche Übung 1401",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=s321401",
									"url": sap.ui.require.toUrl("s321401")
								}
							}
						}
					}
