					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "TestApp Titel für S32",
									"targetURL": "#s32module-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"s32module-display": {
								"semanticObject": "s32module",
								"action": "display",
								"description": "Dies ist eine Fiori Applikation von Julian Kirch.",
								"title": "TestApp Titel für S32",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=s32module",
									"url": sap.ui.require.toUrl("s32module")
								}
							}
						}
					}
