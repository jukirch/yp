			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"s321301-display": {
								"semanticObject": "s321301",
								"action": "display",
								"description": "Irgendein Film Gedöns Beispiel",
								"title": "Film Gedöns",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=s321301",
									"url": sap.ui.require.toUrl("s321301")
								}
							}
						}
					}
