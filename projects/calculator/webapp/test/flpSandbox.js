			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"calculator-display": {
								"semanticObject": "calculator",
								"action": "display",
								"description": "Eine Taschenrechner App.",
								"title": "Calculator",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=calculator",
									"url": sap.ui.require.toUrl("calculator")
								}
							}
						}
					}
