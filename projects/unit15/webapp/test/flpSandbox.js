			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"unit15-display": {
								"semanticObject": "unit15",
								"action": "display",
								"description": "Die gesammelte Übung für Unit 15",
								"title": "Übung U15",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=unit15",
									"url": sap.ui.require.toUrl("unit15")
								}
							}
						}
					}
