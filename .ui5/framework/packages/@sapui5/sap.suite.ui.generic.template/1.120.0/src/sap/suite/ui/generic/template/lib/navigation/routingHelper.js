...
sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	var oStandardBehaviour = { 
		...
		var oCrossAppNavServicePromise = (sap && sap.ushell && sap.ushell.Container) ? sap.ushell.Container.getServiceAsync("CrossApplicationNavigation") : (function(){
			var i = 0;
			var oResolved = {
			...
			return Promise.resolve({
				createEmptyAppState: fnCreateEmptyAppState,
				createEmptyAppStateAsync: function(){
