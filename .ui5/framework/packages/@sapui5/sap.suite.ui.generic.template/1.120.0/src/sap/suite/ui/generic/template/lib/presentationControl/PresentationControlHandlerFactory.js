sap.ui.define([
    ...
    */
    var oDummyHandler = {
        ...
        // returns the string value which should be used to get the pressed item's instance of the smart table in case of chevron navigation
    ...
    function getMethods(oController, oCommonUtils, oComponentUtils) {
        /* In case of multiple tables mode, the entitySet is actually derived from the manifest settings for the corresponding tab and in all other 
           ...
           Similarly, all other instance should also get adapted accordingly */
