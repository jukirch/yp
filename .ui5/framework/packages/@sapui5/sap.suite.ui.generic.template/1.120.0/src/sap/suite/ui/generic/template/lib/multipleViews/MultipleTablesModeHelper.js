sap.ui.define([
...
], function(BaseObject, Device, Filter, oDataModelHelper, testableHelper, extend, StableIdHelper, isEmptyObject) {
	"use strict";
	/*
	...
	function getMethods(oController, oTemplateUtils, oConfiguration) {
		...
		function getPropertyName(sPath) {
			var oPathInfo = oDataModelHelper.splitAccessPath(sPath);
			return oPathInfo.property;
		}
