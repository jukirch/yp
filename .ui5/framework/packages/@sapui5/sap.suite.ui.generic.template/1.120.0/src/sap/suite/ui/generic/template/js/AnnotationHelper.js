...
*/
		...
		buildRatingIndicatorSubtitleExpression: function (mSampleSize) {
			if (mSampleSize) {
				return "{parts: [{path: '" + mSampleSize.Path + "'}], formatter: 'sap.suite.ui.generic.template.js.RuntimeFormatters.formatRatingIndicatorSubTitle'}";
			}
		},
		...
		buildRatingIndicatorFooterExpression: function (mValue, mTargetValue) {
			if (mTargetValue) {
				return "{parts: [{path: '" + mValue.Path + "'}, {path: '" + mTargetValue.Path + "'}], formatter: 'sap.suite.ui.generic.template.js.RuntimeFormatters.formatRatingIndicatorFooterText'}";
			}
			return "{parts: [{path: '" + mValue.Path + "'}], formatter: 'sap.suite.ui.generic.template.js.RuntimeFormatters.formatRatingIndicatorFooterText'}";
		},
		...
		buildRatingIndicatorAggregateCountExpression: function (mValue) {
			return "{parts: [{path: '" + mValue.Path + "'}], formatter: 'sap.suite.ui.generic.template.js.RuntimeFormatters.formatRatingIndicatorAggregateCount'}";
		},
		...
		// is called from LightBoxItem Control, which actually supresses the visibility of the
		...
		_determineColumnIndexForDraftColumn: function (oContext, oLineItem) {
			...
			var iLastOccurenceOfSlash = sLineItemPath.lastIndexOf("/");
			var sEntityTypePath = sLineItemPath.substring(0, iLastOccurenceOfSlash);
		...
		buildExpressionForProgressIndicatorDisplayValue: function (oInterface, dataPoint, mUoM) {
			...
			var sDisplayValueExpression = "{ parts: [" + sParts + "], formatter: 'sap.suite.ui.generic.template.js.RuntimeFormatters.formatDisplayValueForProgressIndicator' }";
		...
		setRowHighlight: function (oEntityType, oTreeNode, sListEntitySet, fnCheckIsDraftEnabled) {
			...
			return "{parts: [" + sDraftParts + ", " + sMessageParts + sCriticalityPiece + ", {path: ''}], formatter: 'sap.suite.ui.generic.template.js.RuntimeFormatters.setInfoHighlight'}";
		},
