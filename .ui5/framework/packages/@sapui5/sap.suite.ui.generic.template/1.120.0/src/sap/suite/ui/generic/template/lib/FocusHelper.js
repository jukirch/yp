	...
	"sap/suite/ui/generic/template/genericUtilities/FeLogger"
		...
		function getMethods(oTemplateContract) {
			...
			function fnFallback(oBeforeData, oAdditionalData){
				...
				// If the busy session ends together with a logic that leaves the application no component will be active anymore -> no focus to be set.
				var oRegistryEntry = sMainComponentId && oTemplateContract.componentRegistry[sMainComponentId];
				if (oRegistryEntry && oRegistryEntry.methods.setFocus){
