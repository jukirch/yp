sap.ui.define([
    ...
    function SmartTableInfo(oBlockSettings, oController, oTemplateUtils, oInfoObjectHandler) {
        ...
        var aDataFields; // List of data fields for this smart table according to the line item. Initialized in fnInitializeBasedOnControl.
        ...
        */
        ...
        function fnInitializeBasedOnControl(oControl) {
            ...
            var sLineItemSuffix = oCustomDataForLineItemQualifier ? ("#" + oCustomDataForLineItemQualifier.getValue()) : "";
            aDataFields = oEntityType["com.sap.vocabularies.UI.v1.LineItem" + sLineItemSuffix] || [];

            // add information about hidden columns
            fnHandleSmartTableColumnHideAtInit(oMetaModel, oEntityType, aDataFields);
        ...
        */
        function fnHandleSmartTableColumnHideAtInit(oMetaModel, oEntityType, aDataFields) {
        ...
        */
        ...
        function getNavigationProperty(){
            return oBlockSettings.navigationProperty;
        }
        
        function getColumnKeyForProperty(sProperty){
			var oDataField = aDataFields.find(function(oDataField){
				return (oDataField.Value && oDataField.Value.Path) === sProperty;
			});
			return oDataField ? AnnotationHelper.createP13NColumnKey(oDataField) : sProperty;
        }
        ...
        return {
            restrictedObject: {
                ...
                getColumnKeyForProperty: getColumnKeyForProperty
            },
