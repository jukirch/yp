...
sap.ui.define([
    ...
    KeyboardNavigation.prototype.layoutItemFocusHandler = function () {
        ...
        if (jqFocused) {
            ...
            // Fix - for all list card - list items being read multiple times.
            var bNotListCard = jqFocused.find(".sapOvpExtendedBarListHBox,.sapOvpBarCondensedList,.sapOvpObjectListItem,.sapOvpStandardListItem").length === 0;
            if (isNotStackCardHeader && bNotListCard) {
    ...
    */
    ...
    var EasyScanLayout = Control.extend("sap.ovp.ui.EasyScanLayout", {
        ...
        renderer: {
            render: function (oRm, oControl) {
                var aCards = CoreComponent.get(oControl._sOwnerId) && CoreComponent.get(oControl._sOwnerId).oOvpConfig.cards;
    ...
    EasyScanLayout.prototype.init = function () {
        ...
        if (CoreComponent.get(this._sOwnerId) && CoreComponent.get(this._sOwnerId).oOvpConfig.cards.length === 0) {
