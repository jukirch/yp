...
sap.ui.define([
    ...
    var oLogger = new OVPLogger("ovp.cards.generic.base.linklist.BaseLinklist");

    return CardController.extend("sap.ovp.cards.generic.base.linklist", {
        onInit: function () {
        ...
        onAfterRendering: function (oEvent) {
            ...
            var oLinkList = this.byId("ovpLinkList");
            if (oLinkList) {
                oLinkList.attachBrowserEvent("click", this.updateControlPressed.bind(this));
            }
        },
         ...
         */
        resizeCard: function (newCardLayout, oCardSizeProperties) {
            ...
            oCardPropertiesModel.setProperty("/cardLayout/itemHeight", oCardSizeProperties.itemHeight);
        ...
        onLinkListLineItemUrl: function (oEvent) {
            if (OVPCardAsAPIUtils.checkIfAPIIsUsed(this)) {
                ...
                if (oNavigation.hasOwnProperty("String")) {
                    ...
                    var oNavigationFields =  NavigationHelper.getEntityNavigationEntries(
                        oEvent.getSource().getBindingContext(),
                        this.getModel(),
                        this.getEntityType(),
                        this.getCardPropertiesModel(),
