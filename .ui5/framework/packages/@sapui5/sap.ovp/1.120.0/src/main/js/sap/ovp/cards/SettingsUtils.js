    ...
    function getCrossAppNavigationLinks(oModel) {
        ...
        if (sap.ushell && sap.ushell.Container) {
            sap.ushell.Container.getServiceAsync("CrossApplicationNavigation").then(function (oCANService) {
                oCANService.getLinks().then(function (aLinks) {
                    var aAllIntents = [],
                        aCardsIntent = [],
                        oLinkToTextMapping = {};
                   ...
                   oCANService.isNavigationSupported(aCardsIntent).then(function (aResponses) {
                       ...
                       for (var i = 0; i < aResponses.length; i++) {
                           if (
                               ...
                               oLinkToTextMapping &&
                               oLinkToTextMapping[i]
                           ) {
                               aLinks.push({ name: oLinkToTextMapping[i], value: i });
                           }
                       }
