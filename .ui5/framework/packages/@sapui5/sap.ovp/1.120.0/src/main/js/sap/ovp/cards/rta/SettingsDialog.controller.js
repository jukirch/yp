...
sap.ui.define([
    ...
    return Controller.extend("sap.ovp.cards.rta.SettingsDialog", {
        ...
        createValueHelpDialogForInternalUrl: function (oEvent) {
            ...
            // Links Dialog
            var oLinksDialogViewSettings = {
                id: "linksDialogContent",
            ...
            View.create(oLinksDialogViewSettings).then(
                function (oView) {
                    oView.setModel(oExtraStaticCardPropertiesModel);
                    oView.setModel(this.getView().getModel("ovpResourceModel"), "ovpResourceModel");
                    this.linksDialog.addContent(oView);
        ...
        onChangeVisualPress: function (oEvent) {
            ...
            // Icons Dialog
            var oIconsDialogViewSettings = {
                id: "iconsDialogContent",
            ...
            View.create(oIconsDialogViewSettings).then(
                function (oView) {
                    // Initially setting Table Name to "IconTable"
                    oRowsModel.setProperty("/tableName", "IconTable");

                    oView.setModel(oRowsModel);
                    oView.setModel(this.getView().getModel("ovpResourceModel"), "ovpResourceModel");
                    this.iconsDialog.addContent(oView);
        ...
        _fCardWithRefresh: function (oEvent, updateProperty) {
            ...
            switch (updateProperty) {
                ...
                case "enableAddToInsights":
                    oCardManifestSettings[updateProperty] = oEvent.getSource().getState() ? true : false;
                    break;
                case "kpiHeader":
                    oView = this.getView();
                    oVisibilityModel = oView.getModel("visibility");
        ...
        getListItems: function () {
            ...
            oCardManifestSettings.lineItem.forEach(function (lineItem) {
                ...
                var aDataFieldsObjects = CardAnnotationHelper.getSortedDataFields(iContext, lineItem.fields);
        ...
        onSeePress: function () {
            ...
            var oKPIItemViewSettings = {
                id: "KPIItemDialogContent",
            ...
            View.create(oKPIItemViewSettings).then(
                function (oView) {
                    oView.setModel(oRowsModel);
                    oView.setModel(this.getView().getModel("ovpResourceModel"), "ovpResourceModel");
                    this.KPIItemDialog.addContent(oView);
        ...
        openLineItemValueHelpDialog: function (oEvent) {
            ...
            // LineItem Dialog
            var oLineItemDialogViewSettings = {
                id: "lineItemDialogContent",
            ...
            View.create(oLineItemDialogViewSettings).then(
                function (oView) {
                    oView.setModel(oRowsModel);
                    oView.setModel(this.getView().getModel("ovpResourceModel"), "ovpResourceModel");
                    this.lineItemDialog.addContent(oView);
