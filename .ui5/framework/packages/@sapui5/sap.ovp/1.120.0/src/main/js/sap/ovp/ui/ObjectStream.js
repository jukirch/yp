...
sap.ui.define([
    ...
    ObjectStream.prototype._mouseLeave = function (e) {
        ...
        this.rtl = Core.getConfiguration().getRTL();
        var transformX;
    ...
    ObjectStream.prototype._mouseEnter = function (evt) {
        ...
        if (evt.target == evt.data.jqRightEdge.get(0) || evt.currentTarget == evt.data.jqRightEdge.get(0)) {
            scrollDirection = Core.getConfiguration().getRTL() ? "left" : "right";
        }
        if (evt.target == evt.data.jqLeftEdge.get(0) || evt.currentTarget == evt.data.jqLeftEdge.get(0)) {
            scrollDirection = Core.getConfiguration().getRTL() ? "right" : "left";
        }
    ...
    ObjectStream.prototype._checkEdgesVisibility = function () {
        ...
        if (Core.getConfiguration().getRTL() && this.scrollReverse) {
