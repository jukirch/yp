...
import type { ValueListParameterInTypes } from "@sap-ux/vocabularies-types/vocabularies/Common";
...
type ValueListInfoResult = {
	Parameters: MetaModelType<ValueListParameterInTypes>[];
...
export async function _getDisplayModeFromValueHelp(
	...
	return metaModel.requestValueListInfo(context.getPath(), true, context).then(function (
		valueListInfo: Record<string, ValueListInfoResult>
	) {
