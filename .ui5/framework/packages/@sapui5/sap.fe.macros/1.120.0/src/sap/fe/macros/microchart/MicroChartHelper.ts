...
import type MicroChartBlock from "./MicroChart.block";
...
const MicroChartHelper = {
	 ...
	 */
	formatDecimal: function (path: string, property: Property, fractionDigits: number, value?: number): string | undefined {
		if (path) {
			const constraints = [],
