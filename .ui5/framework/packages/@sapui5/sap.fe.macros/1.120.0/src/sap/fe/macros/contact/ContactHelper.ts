import type { EmailAddressType } from "@sap-ux/vocabularies-types/vocabularies/Communication";
 ...
 */
export const getMsTeamsMail = function (contactDataModelObject: DataModelObjectPath): CompiledBindingToolkitExpression | undefined {
	...
	//or the first mail
	teamsMail = teamsMail || (contactDataModelObject.targetObject?.email?.length && contactDataModelObject.targetObject.email[0]);
	return teamsMail
