 ...
 */
sap.ui.define(["sap/ui/VersionInfo", "sap/ui/core/Core"], function (VersionInfo, Core) {
  "use strict";
  ...
  async function showCollaborationManagerCardPreview(card, cmInstance) {
    ...
    const cardHelperInstance = await cardHelper.getServiceAsync("UIService");
    const buttonText = Core.getLibraryResourceBundle("sap.fe.macros").getText("C_SEND_TO_COLLABORATION_MANAGER");
