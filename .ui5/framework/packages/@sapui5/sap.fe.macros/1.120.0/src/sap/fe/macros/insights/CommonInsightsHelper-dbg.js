 ...
 */
sap.ui.define(["sap/fe/core/CommonUtils", "sap/fe/core/helpers/ResourceModelHelper", "sap/m/MessageBox", "sap/ui/core/Core", "sap/ui/mdc/p13n/StateUtil", "../filterBar/adapter/StateFilterToSelectionVariant"], function (CommonUtils, ResourceModelHelper, MessageBox, Core, StateUtil, stateFilterToSelectionVariant) {
  "use strict";
  ...
  function isInsightsCardCreationPossible(filterbarId, insightsRelevantColumns) {
    ...
    if (filterBar !== null && filterBar !== void 0 && filterBar.isA("sap.fe.core.controls.FilterBar")) {
    ...
    if (selectionOptionsPropertyNames.length) {
      ...
      for (const parameter of parameters) {
        ...
        if (selectionOptionsPropertyNames.includes(parameter) && parameterType) {
          var _selectionVariant$get;
          relevantParameters[parameter] = {
            value: (_selectionVariant$get = selectionVariant.getSelectOption(parameter)) === null || _selectionVariant$get === void 0 ? void 0 : _selectionVariant$get[0].Low,
            type: parameterType
          };
        }
      }
  ...
  function hasInsightActionEnabled(actions) {
