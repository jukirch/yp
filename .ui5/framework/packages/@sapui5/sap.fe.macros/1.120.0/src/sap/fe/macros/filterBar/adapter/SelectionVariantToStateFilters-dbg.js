...
sap.ui.define(["sap/fe/core/CommonUtils", "sap/fe/core/helpers/BindingToolkit", "sap/fe/core/templating/DisplayModeFormatter", "sap/fe/core/templating/FilterHelper", "sap/fe/macros/filter/FilterFieldHelper", "sap/ui/mdc/enums/ConditionValidated", "sap/ui/mdc/util/FilterUtil"], function (CommonUtils, BindingToolkit, DisplayModeFormatter, FilterHelper, FilterFieldHelper, ConditionValidated, FilterUtil) {
  ...
  const selectionVariantToStateFilters = {
     ...
     */
    getStateFiltersFromSV: function (selectionVariant, filterBarInfoForConversion, filterBarPropertyInfos) {
      const {
        contextPath
    ...
    _getPropertyFilterConfigurationSetting: function (property, filterFieldsConfig) {
      ...
      return (filterFieldsConfig === null || filterFieldsConfig === void 0 ? void 0 : (_filterFieldsConfig$p = filterFieldsConfig[property]) === null || _filterFieldsConfig$p === void 0 ? void 0 : _filterFieldsConfig$p.settings) ?? {};
    },
    /**
    ...
    _getPropertyConditions: function (propertyConversionInfo, selectOptionName, isParameter) {
      ...
      let conditionObjects = [];
      if (selectOptions !== null && selectOptions !== void 0 && selectOptions.length && maximumConditions !== 0) {
    ...
    _getSemanticDateOperators: function (propertyConversionInfo, isParameter) {
      ...
      if (useSemanticDateRange) {
        if (isParameter) {
          ...
          semanticDateOperators = CommonUtils.getOperatorsForProperty(propertyName, propertyEntitySetPath, metaModel, ODATA_TYPE_MAPPING[propertyMetadata.dataType], useSemanticDateRange, filterSettings);
        }
      }
     ...
     */
    _adjustValueHelpCondition: condition => {
