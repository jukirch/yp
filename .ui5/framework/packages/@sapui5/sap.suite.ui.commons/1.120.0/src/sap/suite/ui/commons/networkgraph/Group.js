...
sap.ui.define([
	...
	"sap/ui/core/Core",
	"sap/ui/core/Lib"
], function (library, jQuery, ElementBase, IconPool, CheckBox, Core, CoreLib) {
	"use strict";
	...
	Group.prototype._renderHeader = function (mOptions) {
		...
		this._renderHtmlIcon(this.getCollapsed() ? EXPAND_ICON : COLLAPSE_ICON, "sapSuiteUiCommonsNetworkGroupHeaderMenuIcon", "collapse",
			mOptions.renderManager ? sContentStyleVal : sContentStyle, oResourceBundle.getText("NETWORK_GRAPH_EXPAND_COLLAPSE"), mOptions.renderManager);
		this._renderHtmlIcon(MENU_ICON, "sapSuiteUiCommonsNetworkGroupHeaderMenuIcon", "menu",
			mOptions.renderManager ? sContentStyleVal : sContentStyle, oResourceBundle.getText("NETWORK_GRAPH_GROUP_DETAILS"), mOptions.renderManager);
		mOptions.renderManager.close("div");
