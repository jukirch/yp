 ...
 sap.ui.define([
	...
	var oSuiteCommonsLib = Core.initLibrary({
		...
		types: [
			...
			"sap.suite.ui.commons.LayoutType"
		],
		interfaces: [],
		controls: [
			...
			"sap.suite.ui.commons.ToDosContainer",
			"sap.suite.ui.commons.InsightsContainer",
			"sap.suite.ui.commons.ToDosContainer",
			"sap.suite.ui.commons.AppsContainer",
			"sap.suite.ui.commons.NewsAndPageContainer"
		],
		elements: [
			...
			"sap.suite.ui.commons.TaskPanel",
			"sap.suite.ui.commons.SituationPanel",
			"sap.suite.ui.commons.CardsPanel",
			"sap.suite.ui.commons.FavAppPanel",
			"sap.suite.ui.commons.RecentAppPanel",
			"sap.suite.ui.commons.FrequentAppPanel",
			"sap.suite.ui.commons.App",
			"sap.suite.ui.commons.Group",
			"sap.suite.ui.commons.NewsPanel",
