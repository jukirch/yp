				...
				function generateResponse(fServer) {
					...
					fServer.respondWith("POST", RegExp("/sap","i"), function (xhr, id) {
						...
						if (xhr.requestBody.includes("FileShareItems(FileShare='ZPERSONAL',FileShareItem='0ACGgV1bbQGeXUk9PVA')/_Children")) {
							if ((xhr.requestBody.includes("POST") ) || xhr.requestBody.includes("1WxgMHSZO9QEGLEHMthmavGBm_1gvdTFC") ) {
								obj['@odata.context'] = "../../$metadata#FileShareItems/$entity";
								obj['@odata.metadataEtag'] = "W/\"20220721182137\"";
								obj['FileShareItem'] =  "1WxgMHSZO9QEGLEHMthmavGBm_1gvdTFC";
								obj["FileShare"] =  "ZPERSONAL";
								obj['CreatedByUser'] = "tester_em_go@sapworkspace.com";
								obj['CreationDateTime'] = "2023-09-21T08:34:44.615Z";
								obj['FileShareItemContent@odata.mediaContentType']= null;
								obj["FileShareItemContentLink"] =  "";
								obj["FileShareItemContentSize"]= "0";
								obj["FileShareItemContentType"]= "";
								obj["FileShareItemConvertToMimeType"]="";
								obj["FileShareItemHumanContentType"]= "Folder";
								obj["FileShareItemKind"]= "folder";
								obj["FileShareItemName"]= "New Folder";
								obj["LastChangeDateTime"]="2023-09-21T08:34:44.615Z";
								obj["LastChangedByUser"]= "tester_em_go@sapworkspace.com";
								obj["ParentFileShareItem"]= "0ACGgV1bbQGeXUk9PVA";
								obj["__CreateByAssociationControl"]= {
								"_Children": true
								};
								obj["__EntityControl"]= {
								"Deletable": true,
								...
								if(xhr.requestBody.includes("POST")) {
									mockData['fileShareItemsChildrenValue'].unshift(obj);
								}		
							} else {
								obj['value'] = mockData['fileShareItemsChildrenValue'];
							}
							fnGetBatchData(xhr, rBatch, obj);
						} else if (xhr.requestBody.includes("GET FileShareQuery")) {
								obj['value'] = [];
							fnGetBatchData(xhr, rBatch, obj);
						} else {
						...
						if (rBatch.test(xhr.url)) {
							...
							if (sBoundary) {
								...
								aBatchRequests.forEach(function (sBatchRequest, index) {
									...
									else if (rPost.exec(sBatchRequest)){
										var sResponseString;
										//Getting JSON Data and creating the Response string
										var oResponse = mockData;
