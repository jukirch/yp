...
sap.ui.define([ './DateUtils', "sap/ui/core/date/UI5Date", "sap/ui/core/Core", "sap/ui/core/Lib" ], function(DateUtils, UI5Date, Core, CoreLib) {
	"use strict";
	...
	FeedItemUtils.calculateFeedItemAge = function(dPublicationDate) {
		...
		var oLocale = Core.getConfiguration().getLanguage();
		var oResBundle = CoreLib.getResourceBundleFor("sap.suite.ui.commons", oLocale);
