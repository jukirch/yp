sap.ui.define([
	...
	"sap/ui/core/Lib"
], function (jQuery, library, Control, Parameters, TAccountPanel, TAccountGroup, NumberFormat, Core, CoreLibrary, TAccountUtils, BigNumber, CoreLib) {
	"use strict";
