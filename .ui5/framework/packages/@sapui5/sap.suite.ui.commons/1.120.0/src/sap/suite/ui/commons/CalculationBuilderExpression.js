sap.ui.define([
	...
	"sap/ui/thirdparty/jqueryui/jquery-ui-selectable"
			 ...
			 Label, Panel, ResponsivePopover, Toolbar, MessageStrip, ValidationResult, ControlProxy, Icon, coreLibrary, Core, CoreLib) {
	"use strict";
		...
		for (var i = 0; i < aItems.length + 1; i++) {
			...
			if (iIndex === i) {
				$selectedItems.each(function () { // eslint-disable-line
					...
					if ($this.hasClass("sapCalculationBuilderItem")) {
						oItem = Core.byId(jQuery(this)[0].id);
