...
sap.ui.define([
	...
	"sap/ui/core/Core",
	"sap/ui/core/Lib"
], function(jQuery, library, ElementBase, ElementAttribute, IconPool, Device, encodeXML, sanitizeHTML, CheckBox, Text, NodeRenderer, Core, CoreLib) {
	"use strict";
	...
	Node.prototype.init = function(mOptions) {
		...
		if (!Core.isInitialized()) {
			...
			Core.attachInit(this._handleCoreInitialized.bind(this));
		} else {
	...
	Node.prototype._handleCoreInitialized = function() {
		this._bThemeApplied = Core.isThemeApplied();
	...
	Node.prototype._renderCircle = function(mOptions) {
		...
		if (!oRm) {
			...
			sHtml += this._renderControl("circle", oStatusCircleArgs);
		...
		this._renderControl("circle", oStatusCircleArgs, null, oRm);
