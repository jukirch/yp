...
sap.ui.define([
	...
	JSONModel, Sorter, Filter, FilterOperator, ManagedObject, TimelineItem, TimelineRenderManager, ScrollEnablement, BaseObject, assert, Log, UI5Date, Configuration, TimelineRenderer, CoreLib) {
	"use strict";
	...
	Timeline.prototype._getRangeMessage = function () {
		...
		if (!text) {
			...
			if (Configuration.getTimezone() !== Intl.DateTimeFormat().resolvedOptions().timeZone && titleStart instanceof Date && titleEnd instanceof Date) {
