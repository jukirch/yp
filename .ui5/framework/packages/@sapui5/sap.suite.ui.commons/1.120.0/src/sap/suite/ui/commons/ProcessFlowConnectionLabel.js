...
sap.ui.define(['sap/m/Button', './library', 'sap/ui/core/InvisibleText', './ProcessFlowConnectionLabelRenderer', "sap/ui/core/Lib"],
	function(Button, library, InvisibleText, ProcessFlowConnectionLabelRenderer, CoreLib) {
	"use strict";
