...
sap.ui.define(["sap/fe/core/converters/common/AnnotationConverter", "sap/fe/core/helpers/TypeGuards", "../helpers/StableIdHelper"], function (AnnotationConverter, TypeGuards, StableIdHelper) {
  ...
  function prepareEntityType(entityTypeDefinition, entityTypeName, namespacePrefix, metaModelData) {
    var _metaModelData$$Annot, _metaModelData$$Annot2, _metaModelData$$Annot3;
    const entityType = {
      _type: "EntityType",
    ...
    if (!!(entityType !== null && entityType !== void 0 && entityType.keys.length) && metaModelData.$Annotations[entityType.fullyQualifiedName] && !((_metaModelData$$Annot3 = metaModelData.$Annotations[entityType.fullyQualifiedName]) !== null && _metaModelData$$Annot3 !== void 0 && _metaModelData$$Annot3[`@${"com.sap.vocabularies.UI.v1.HeaderInfo"}`])) {
  ...
  function prepareAction(actionRawData, actionName, namespacePrefix) {
    var _overloadParameters$, _actionRawData$$Retur;
    ...
    return {
      ...
      sourceType: ((_overloadParameters$ = overloadParameters[0]) === null || _overloadParameters$ === void 0 ? void 0 : _overloadParameters$.$Type) ?? "",
