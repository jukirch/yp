...
import type { MultiDimensionalGridViewConfiguration, ViewPathConfiguration } from "../../ManifestSettings";
...
export type DataVisualizationDefinition = {
	visualizations: (TableVisualization | ChartVisualization)[] | [MultiDimensionalGridVisualization];
	annotationPath?: string;
};
export type MultiDimensionalGridVisualization = {
	id: string;
	variantManagementId: string;
	type: VisualizationType.MultiDimensionalGrid;
	modelName: MultiDimensionalGridViewConfiguration["modelName"];
	dataProviderName: MultiDimensionalGridViewConfiguration["dataProviderName"];
	dimensionMapping?: MultiDimensionalGridViewConfiguration["dimensionMapping"];
};
...
export const getMultiDimensionalGridVisualization = function (
	configuration: MultiDimensionalGridViewConfiguration
): DataVisualizationDefinition {
	if (Core.getLoadedLibraries().hasOwnProperty("sap.sac.df")) {
		return {
			visualizations: [
				...
				} as MultiDimensionalGridVisualization
			]
		};
	} else {
