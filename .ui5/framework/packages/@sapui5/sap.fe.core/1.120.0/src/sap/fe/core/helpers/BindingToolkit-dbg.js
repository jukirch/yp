...
sap.ui.define(["sap/fe/core/helpers/TypeGuards", "./AnnotationEnum"], function (TypeGuards, AnnotationEnum) {
  ...
  function formatWithTypeInformation(property, propertyBindingExpression) {
    var _outExpression$type, _outExpression$constr3, _outExpression$constr4;
    ...
    if (outExpression.type === "sap.ui.model.odata.type.String" && isProperty(property)) {
      var _outExpression$constr, _outExpression$constr2;
      if (!((_outExpression$constr = outExpression.constraints) !== null && _outExpression$constr !== void 0 && _outExpression$constr.isDigitSequence) || ((_outExpression$constr2 = outExpression.constraints) === null || _outExpression$constr2 === void 0 ? void 0 : _outExpression$constr2.nullable) === false) {
    ...
    if (((_outExpression$constr3 = outExpression.constraints) === null || _outExpression$constr3 === void 0 ? void 0 : _outExpression$constr3.nullable) === false && outExpression.type && typesSupportingParseEmptyValueToZero.includes(outExpression.type)) {
      outExpression.formatOptions = Object.assign(outExpression.formatOptions, {
        parseEmptyValueToZero: true
      });
    }
    if (((_outExpression$constr4 = outExpression.constraints) === null || _outExpression$constr4 === void 0 ? void 0 : _outExpression$constr4.nullable) !== false && (outExpression.type === "sap.ui.model.odata.type.Int64" || outExpression.type === "sap.ui.model.odata.type.Decimal")) {
      outExpression.formatOptions = Object.assign(outExpression.formatOptions, {
        emptyString: ""
      });
    }
