...
export class AggregationHelper {
	 ...
	 */
	constructor(entityType: EntityType, converterContext: ConverterContext, considerOldAnnotations = false) {
	...
	private _getAggregatableAggregates(property: PropertyPath | AnnotationTerm<CustomAggregate>) {
		...
		return aAggregatableProperties.find(function (obj: AggregatablePropertyType | any) {
