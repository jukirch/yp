...
sap.ui.define([], function () {
  ...
  const recommendationHelper = {
    ...
    clearRecommendations: (view, inputBindingContext) => {
      ...
      const createMode = view.getBindingContext("ui").getProperty("createMode");
      if ((currentContext === null || currentContext === void 0 ? void 0 : currentContext.getPath()) !== (inputBindingContext === null || inputBindingContext === void 0 ? void 0 : inputBindingContext.getPath()) || createMode) {
