 ...
 */
sap.ui.define(["sap/base/Log", "sap/fe/core/ActionRuntime", "sap/fe/core/CommonUtils", "sap/fe/core/controllerextensions/BusyLocker", "sap/fe/core/controllerextensions/messageHandler/messageHandling", "sap/fe/core/helpers/FPMHelper", "sap/fe/core/helpers/ResourceModelHelper", "sap/fe/core/helpers/StableIdHelper", "sap/fe/core/library", "sap/m/Button", "sap/m/Dialog", "sap/m/MessageBox", "sap/ui/core/Core", "sap/ui/core/Fragment", "sap/ui/core/XMLTemplateProcessor", "sap/ui/core/library", "sap/ui/core/message/Message", "sap/ui/core/util/XMLPreprocessor", "sap/ui/model/json/JSONModel", "../../../operationsHelper", "./_internal"], function (Log, ActionRuntime, CommonUtils, BusyLocker, messageHandling, FPMHelper, ResourceModelHelper, StableIdHelper, FELibrary, Button, Dialog, MessageBox, Core, Fragment, XMLTemplateProcessor, library, Message, XMLPreprocessor, JSONModel, operationsHelper, _internal) {
  "use strict";
  ...
  function callBoundAction(sActionName, contexts, oModel, oAppComponent, mParameters, strictHandlingUtilities) {
    ...
    mParameters.isCriticalAction = ActionRuntime.getIsActionCritical(oMetaModel, sActionPath, mParameters.aContexts);
  ...
  function callActionImport(sActionName, oModel, oAppComponent, mParameters, strictHandlingUtilities) {
    ...
    mParameters.isCriticalAction = ActionRuntime.getIsActionCritical(oMetaModel, `${sActionPath}/@$ui5.overload`);
  ...
  function callAction(sActionName, oModel, oAction, oAppComponent, mParameters, strictHandlingUtilities) {
    ...
    return new Promise(async function (resolve, reject) {
      ...
      if (oAction.getObject("$IsBound")) {
        var _mParameters$addition, _mParameters$addition2;
        if (((_mParameters$addition = mParameters.additionalSideEffect) === null || _mParameters$addition === void 0 ? void 0 : (_mParameters$addition2 = _mParameters$addition.pathExpressions) === null || _mParameters$addition2 === void 0 ? void 0 : _mParameters$addition2.length) > 0) {
      ...
      if (fnDialog) {
        ...
        try {
          ...
          operations.afterActionResolution(mParameters, mActionExecutionParameters, actionDefinition);
          resolve(oOperationResult);
        } catch {
          reject(oOperationResult);
        } finally {
          ...
          if (mParameters.bGrouped && strictHandlingUtilities && strictHandlingUtilities.strictHandlingPromises.length || isChangeSetAndHasErrorsOrWarnings(mParameters.bGrouped)) {
  ...
  async function executeAPMAction(oAppComponent, mParameters, oParentControl, messageHandler, aContexts, oDialog, after412, strictHandlingUtilities) {
    ...
    if (strictHandlingUtilities && strictHandlingUtilities.is412Executed && strictHandlingUtilities.strictHandlingTransitionFails.length) {
      if (!after412) {
        ...
        Core.getMessageManager().addMessages(strictHandlingUtilities.delaySuccessMessages);
        let showGenericErrorMessageForChangeSet = false;
        if (mParameters.bGrouped && strictHandlingUtilities.strictHandlingPromises.length || isChangeSetAndHasErrorsOrWarnings(mParameters.bGrouped)) {
          showGenericErrorMessageForChangeSet = true;
        }
        if (messages.length) {
  ...
  function actionParameterShowMessageCallback(mParameters, aContexts, oDialog, messages, showMessageParametersIn, showGenericErrorMessageForChangeSet) {
    ...
    const unboundMessages = messages.filter(function (message) {
      var _message$getTargets;
      return ((_message$getTargets = message.getTargets()) === null || _message$getTargets === void 0 ? void 0 : _message$getTargets[0]) === "";
    });
    const APDmessages = messages.filter(function (message) {
      var _message$getTargets2, _mParameters$aActionP;
      return message.getTargets && ((_message$getTargets2 = message.getTargets()) === null || _message$getTargets2 === void 0 ? void 0 : _message$getTargets2[0].indexOf(mParameters.actionName)) !== -1 && (mParameters === null || mParameters === void 0 ? void 0 : (_mParameters$aActionP = mParameters.aActionParameters) === null || _mParameters$aActionP === void 0 ? void 0 : _mParameters$aActionP.some(function (actionParam) {
        var _message$getTargets3;
        return ((_message$getTargets3 = message.getTargets()) === null || _message$getTargets3 === void 0 ? void 0 : _message$getTargets3[0].indexOf(actionParam.$Name)) !== -1;
      }));
    });
    ...
    if (showGenericErrorMessageForChangeSet && !errorTargetsInAPD) {
      ...
      if (nonErrorMessageExistsInDialog !== 1 && nonErrorMessageExistsInModel !== -1 && (mParameters === null || mParameters === void 0 ? void 0 : (_mParameters$aContext2 = mParameters.aContexts) === null || _mParameters$aContext2 === void 0 ? void 0 : _mParameters$aContext2.length) > 1) {
    ...
    if (!hasChangeSetModifiedMessage) {
      var _messages$0$getTarget, _messages$0$getTarget2;
      if (messages.length === 1 && messages[0].getTargets && ((_messages$0$getTarget = messages[0].getTargets()) === null || _messages$0$getTarget === void 0 ? void 0 : _messages$0$getTarget[0]) !== undefined && ((_messages$0$getTarget2 = messages[0].getTargets()) === null || _messages$0$getTarget2 === void 0 ? void 0 : _messages$0$getTarget2[0]) !== "") {
              ...
              try {
                ...
                try {
                  ...
                  for (const i in aActionParameters) {
                    ...
                    aActionParameters[i].value = vParameterValue; // writing the current value (user input!) into the metamodel => should be refactored to use ActionParameterInfos instead. Used in setActionParameterDefaultValue
                  ...
                  try {
                    const aResult = await executeAPMAction(oAppComponent, innerParameters, oParentControl, messageHandler, aContexts, oDialog, false, strictHandlingUtilities);
                    actionResult = {
                    ...
                    if (strictHandlingUtilities && strictHandlingUtilities.is412Executed && strictHandlingUtilities.strictHandlingTransitionFails.length) {
                      try {
                        failedContexts = strictHandlingUtilities.strictHandlingTransitionFails.map(fail => fail.oAction.getContext());
                        innerParameters.aContexts = failedContexts;
                        const aResult = await executeAPMAction(oAppComponent, innerParameters, oParentControl, messageHandler, aContexts, oDialog, true, strictHandlingUtilities);
                        strictHandlingUtilities.strictHandlingTransitionFails = [];
                        actionResult = {
                          dialogCancelled: false,
                          result: aResult
                        ...
                        await messageHandler.showMessageDialog({
                          ...
                          onBeforeShowMessage: function (aMessages, showMessageParametersIn) {
                            return actionParameterShowMessageCallback(innerParameters, aContexts, oDialog, aMessages, showMessageParametersIn, showGenericErrorMessageForChangeSet);
                          },
                  ...
                  await messageHandler.showMessages({
                    ...
                    // only used in case of failed context to reset in messageHandling showUnboundMessages
                    isActionParameterDialogOpen: oDialog.isOpen(),
  ...
  function executeDependingOnSelectedContexts(oAction, mParameters, bGetBoundContext, sGroupId, resourceModel, messageHandler, iContextLength, current_context_index, internalOperationsPromiseResolve, internalOperationsPromiseReject, strictHandlingUtilities) {
    ...
    if (bGetBoundContext) {
      ...
      if (mParameters.disableStrictHandling) {
        bEnableStrictHandling = false;
      }
    }
  ...
  /**
   * Checks if there are any warning or error messages(bound and unbound). Presently only provides them for changeset batch config.
   *
   * @param isChangeSet The request configuration
   * @returns Boolean indicating existance of messages
   */
  function isChangeSetAndHasErrorsOrWarnings(isChangeSet) {
    let messages = [];
    if (isChangeSet) {
      const unBoundMsgs = messageHandling.getMessages();
      const boundMsgs = messageHandling.getMessages(true);
      messages = [...unBoundMsgs, ...boundMsgs];
    }
    ...
    if (aContexts.length) {
      ...
      return new Promise(function (resolve) {
        ...
        const fnExecuteSingleAction = function (actionContext, current_context_index, oSideEffect, iContextLength) {
          ...
          setActionParameterDefaultValue();
          // For invocation grouping "isolated" need batch group per action call
          sGroupId = mParameters.groupId || `apiMode${current_context_index}`;
          mParameters.requestSideEffects = fnRequestSideEffects.bind(operations, oAppComponent, oSideEffect, mParameters, sGroupId, individualActionPromise);
          oActionPromise = executeDependingOnSelectedContexts(actionContext, mParameters, bGetBoundContext, sGroupId, resourceModel, messageHandler, iContextLength, current_context_index, ointernalOperationsPromiseObject.internalOperationsPromiseResolve, ointernalOperationsPromiseObject.internalOperationsPromiseReject, strictHandlingUtilities);
          aActionPromises.push(oActionPromise);
          individualActionPromise.push(ointernalOperationsPromiseObject.oLocalActionPromise);
        ...
        async function fnExecuteChangeset() {
          ...
          if (strictHandlingUtilities && strictHandlingUtilities.strictHandlingPromises.length) {
            try {
              if (!isChangeSetAndHasErrorsOrWarnings(true)) {
        ...
        async function fnExecuteSequentially(contextsToExecute) {
          ...
          function processOneAction(context, actionIndex, iContextLength) {
            var _mParameters$control, _mParameters$control$, _mParameters$control$2;
            ...
            const initialTableContext = (_mParameters$control = mParameters.control) === null || _mParameters$control === void 0 ? void 0 : (_mParameters$control$ = _mParameters$control.getRowBinding) === null || _mParameters$control$ === void 0 ? void 0 : (_mParameters$control$2 = _mParameters$control$.call(_mParameters$control)) === null || _mParameters$control$2 === void 0 ? void 0 : _mParameters$control$2.getHeaderContext();
            return fnExecuteSingleAction(oAction, actionIndex, {
              context: initialTableContext && initialTableContext.getPath() === context.getPath() ? initialTableContext : context,
              pathExpressions: mParameters.additionalSideEffect && mParameters.additionalSideEffect.pathExpressions,
              triggerActions: mParameters.additionalSideEffect && mParameters.additionalSideEffect.triggerActions
            }, iContextLength);
          }
  ...
  const operations = {
    ...
    isChangeSetAndHasErrorsOrWarnings: isChangeSetAndHasErrorsOrWarnings
  };
  return operations;
}, false);
