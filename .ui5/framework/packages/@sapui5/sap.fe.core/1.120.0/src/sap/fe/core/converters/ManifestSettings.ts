...
export enum VisualizationType {
	Table = "Table",
	Chart = "Chart",
	MultiDimensionalGrid = "MultiDimensionalGrid"
}
...
export type SingleMultiDimensionalGridDimensionMapping = {
	filterProperty?: string;
} & (
	| { navigationType: undefined }
	| { navigationType: "internal"; navigationEntitySet?: string }
	| { navigationType: "external"; navigationKeyProperty?: string; navigationSemanticObject?: string }
);

export type MultiDimensionalGridDimensionMapping = {
	[key: string]: SingleMultiDimensionalGridDimensionMapping;
};

export type MultiDimensionalGridViewConfiguration = {
	type: "MultiDimensionalGrid";
	modelName: string;
	dataProviderName: string;
	dimensionMapping?: MultiDimensionalGridDimensionMapping;
};

export type CombinedViewPathConfiguration = {
	primary: SingleViewPathConfiguration[] | [MultiDimensionalGridViewConfiguration];
	secondary: SingleViewPathConfiguration[] | [MultiDimensionalGridViewConfiguration];
