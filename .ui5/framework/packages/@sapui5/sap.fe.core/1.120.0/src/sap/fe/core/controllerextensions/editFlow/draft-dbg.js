...
sap.ui.define(["sap/base/Log", "sap/fe/core/CommonUtils", "sap/fe/core/controllerextensions/messageHandler/messageHandling", "sap/fe/core/converters/MetaModelConverter", "sap/fe/core/helpers/ResourceModelHelper", "sap/m/Button", "sap/m/Dialog", "sap/m/MessageBox", "sap/m/Text", "sap/ui/core/Core", "../../helpers/ModelHelper", "../../operationsHelper", "./draftDataLossPopup"], function (Log, CommonUtils, messageHandling, MetaModelConverter, ResourceModelHelper, Button, Dialog, MessageBox, Text, Core, ModelHelper, operationsHelper, draftDataLossPopup) {
   ...
   */
  async function executeDraftEditAction(oContext, bPreserveChanges, oView, groupId, overwriteChange) {
    if (oContext.getProperty("IsActiveEntity")) {
      ...
      const oEditPromise = oOperation.execute(groupId, undefined, operationsHelper.fnOnStrictHandlingFailed.bind(draft, groupId, {
        label: sActionName,
  ...
  async function computeSiblingInformation(rootCurrentContext, rightmostCurrentContext, rootContextInfo, groupId) {
    ...
    try {
      ...
      if (rootContextInfo !== null && rootContextInfo !== void 0 && rootContextInfo.rootSiblingPathPromise) {
      ...
      if (rootContextInfo !== null && rootContextInfo !== void 0 && rootContextInfo.rootSiblingPathPromise) {
        var _await$rootContextInf;
        const rootSiblingPath = (_await$rootContextInf = await rootContextInfo.rootSiblingPathPromise) === null || _await$rootContextInf === void 0 ? void 0 : _await$rootContextInf.getPath();
   ...
   */
  async function createDraftFromActiveDocument(oContext, oAppComponent, mParameters, groupId) {
  ...
  function deleteDraft(oContext, oAppComponent, bEnableStrictHandling) {
    ...
    if (bIsActiveEntity || !bIsActiveEntity && !sDiscardAction) {
      ...
      if (oContext.hasPendingChanges()) {
        ...
        return !oContext.getProperty("IsActiveEntity") && oContext.getProperty("HasActiveEntity") && ModelHelper.isDraftRoot((_getInvolvedDataModel = getInvolvedDataModelObjects(oContext.getModel().getMetaModel().getMetaContext(oContext.getPath()))) === null || _getInvolvedDataModel === void 0 ? void 0 : _getInvolvedDataModel.targetEntitySet) ? oContext.getModel().delete(oContext) : oContext.delete();
      }
    } else {
