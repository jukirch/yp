	...
	var ExportBase = EventProvider.extend('sap.ui.export.ExportBase', {
		...
		constructor: function(mSettings, mCapabilities) {
			...
			if (this._mSettings.workbook) {
				this._mSettings.workbook.hierarchyLevel = ExportUtils.getHierarchyLevelProperty(mSettings.dataSource) || this._mSettings.workbook.hierarchyLevel;
				this._mSettings.workbook.drillState = ExportUtils.getHierarchyDrillStateProperty(mSettings.dataSource) || this._mSettings.workbook.drillState;
			}
		}
	});
