...
sap.ui.define([
    ...
    function getNotificationButton () {
        return Core.byId("NotificationsCountButton");
    }
    ...
    return UIComponent.extend("sap.ushell.components.shell.Notifications.Component", {
        ...
        createContent: function () {
            ...
            sap.ushell.Container.getServiceAsync("NotificationsV2").then(function (oNotificationsService) {
                ...
                if (this.oNotificationsService.isEnabled() === true) {
                    Core.getEventBus().subscribe("sap.ushell.services.Notifications", "onNewNotifications", this._handleAlerts, this);
        ...
        _toggleNotifications: function (bShow) {
            this._getPopover().then(function (oPopover) {
                ...
                if (!oSource.$().width()) {
                    oSource = Core.byId("endItemsOverflowBtn");
                }
        ...
        exit: function () {
            Core.getEventBus().unsubscribe("sap.ushell.services.Notifications", "onNewNotifications", this._handleAlerts, this);
            ...
            this.oRenderer = null;
            var oNotificationsPopover = Core.byId("notificationsView");
