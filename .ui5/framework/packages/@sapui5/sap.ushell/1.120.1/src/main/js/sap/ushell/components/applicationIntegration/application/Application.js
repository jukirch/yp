...
sap.ui.define([
    ...
    "sap/ui/core/Core",
    "sap/ushell/Config"
], function (ApplicationContainer, PostMessageAPI, utils, jQuery, URI, UI5ComponentType, Log, ObjectPath, Core, Config) {
    "use strict";
    ...
    function Application () {
        ...
        this.handleServiceMessageEvent = function (oContainer, oMessage, oMessageData, oMessageStatus, bIsGlobalMessageListener) {
            ...
            function callService (fnServiceCall, bIsUserMessage) {
                ...
                try {
                    fnServiceCall(oServiceParams).then(function (oResult) {
        ...
        this.createApplicationContainer = function (sAppId, oResolvedNavigationTarget) {
            ...
            if (oActiveApplication.setBlueBoxCapabilities) {
                oActiveApplication.setProperty("blueBoxCapabilities", {}, true);
            }
            if (oActiveApplication.setCurrentAppId) {
                oActiveApplication.setProperty("currentAppId", "application" + sAppId, true);
            }
            if (oActiveApplication.setCurrentAppUrl) {
                oActiveApplication.setProperty("currentAppUrl", oResolvedNavigationTarget.url, true);
            }
            ...
            if (oActiveApplication.setCurrentAppTargetResolution) {
                oActiveApplication.setProperty("currentAppTargetResolution", oResolvedNavigationTarget, true);
            }

            oActiveApplication.setHandleMessageEvent(this.handleMessageEvent);
            BlueBoxHandler.AddNewBlueBox(oActiveApplication, oResolvedNavigationTarget);
        ...
        this.restore = function (oApp) {
            ...
            if (oApp.app) {
                ...
                if (oApp.app.getUrl) {
                    ...
                    oActiveApplication = BlueBoxHandler.getBlueBoxByUrl(this.stripURL(sDomainEnd));
