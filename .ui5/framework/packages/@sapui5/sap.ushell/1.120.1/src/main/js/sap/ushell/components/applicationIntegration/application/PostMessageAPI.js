                            ...
                            return new Promise(function (fnResolve, fnReject) {
                                sap.ui.require(["sap/ushell/components/applicationIntegration/application/PostMessageUtils"], function (PostMessageUtils) {
                                    PostMessageUtils.postMessageToIframeApp(
                                        oServiceParams.oContainer, "sap.ushell.appRuntime", "executeLogoutFunctions", {}, true).then(fnResolve, fnReject);
                                });
                            });
                        }, true);
                        return new jQuery.Deferred().resolve().promise();
                ...
                createShellHeadItem: {
                    executeServiceCallFn: function (oServiceParams) {
                        ...
                        params.press = function () {
                            sap.ui.require(["sap/ushell/components/applicationIntegration/application/PostMessageUtils"], function (PostMessageUtils) {
                                PostMessageUtils.postMessageToIframeApp(oServiceParams.oContainer, "sap.ushell.appRuntime", "buttonClick", { buttonId: params.id });
                            });
                        };
                    ...
                    executeServiceCallFn: function (oServiceParams) {
                        ...
                        aButtons.forEach(function (oButton) {
                            ...
                            new Button({
                                ...
                                press: function () {
                                    sap.ui.require(["sap/ushell/components/applicationIntegration/application/PostMessageUtils"], function (PostMessageUtils) {
                                        PostMessageUtils.postMessageToIframeApp(oServiceParams.oContainer, "sap.ushell.appRuntime", "buttonClick", { buttonId: oButton.id });
                                    });
                                }
                            });
                            /*eslint-enable no-new*/
    ...
    function addRendererButton (sAPI, oServiceParams) {
        sap.ushell.Container.getRenderer("fiori2")[sAPI](
            "sap.ushell.ui.shell.ShellHeadItem",
            {
                ...
                press: function () {
                    sap.ui.require(["sap/ushell/components/applicationIntegration/application/PostMessageUtils"], function (PostMessageUtils) {
                        PostMessageUtils.postMessageToIframeApp(oServiceParams.oContainer, "sap.ushell.appRuntime", "buttonClick", { buttonId: oServiceParams.oMessageData.body.sId });
                    });
                }
            },
            oServiceParams.oMessageData.body.bVisible,
    ...
    PostMessageAPI.prototype.registerAsyncDirtyStateProvider = function (oServiceParams) {
        sap.ushell.Container.setAsyncDirtyStateProvider(function (oNavigationContext) {
            return new Promise(function (fnResolve) {
                var backupTimer;
                sap.ui.require(["sap/ushell/components/applicationIntegration/application/PostMessageUtils"], function (PostMessageUtils) {
                    PostMessageUtils.postMessageToIframeApp(oServiceParams.oContainer,
                        "sap.ushell.appRuntime",
