...
"sap/ui/thirdparty/jquery"
    ...
    /**
     * @name sap.ushell.services.Personalization.TransientPersonalizer
     * @class
     ...
     *
     * @returns {jQuery.Deferred.promise} Promise object which provides the personalization
     ...
     * @returns {jQuery.Deferred.promise} Promise object which returns if the saving was
     ...
     *
     * @returns {jQuery.Deferred.promise} Promise object which returns if the deletion was
     *          successful or erroneous. Promise object done function: no
