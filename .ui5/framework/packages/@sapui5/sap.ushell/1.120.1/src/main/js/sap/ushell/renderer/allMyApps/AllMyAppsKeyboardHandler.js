...
sap.ui.define([
    ...
    KeyboardNavigation.prototype.arrowKeyHandler = function (e, iDirectionFactor) {
        ...
        var oCurrentlyFocusedAppElement = jQuery('.sapUshellAllMyAppsListItem[tabindex="0"]')[0];
        var iCurrentlyFocusedIndex = aDetailAppsElements.indexOf(oCurrentlyFocusedAppElement);
        var oElementToFocus = aDetailAppsElements[iCurrentlyFocusedIndex + iDirectionFactor];
    ...
    (function () {
        setTimeout(() => { // defer by a tick to avoid circular dependencies
            sap.ui.require(["sap/ushell/renderers/fiori2/allMyApps/AllMyAppsKeyboardHandler"], function () {});
        }, 0);
    })();
