...
sap.ui.define([
     ...
     * <code>sap.ushell.Container.getServiceAsync("URLParsing")</code>. For details, see
    ...
    function URLParsing () {
        ...
        this.addSystemToServiceUrl = function (sServiceUrl, vComponentOrSystem) {
            ...
            var oResolution = sap.ushell.Container.getService("NavTargetResolution").getCurrentResolution(); // LEGACY API (deprecated)
