...
], function (UIComponent, SearchField, Button, ResponsivePopover, Fragment, JSONModel, SearchCEPController,
             Log, resources, IconPool, util, ShellHeadItem, Device, Core, jQuery, UrlParsing
) {
    "use strict";
