...
sap.ui.define([
    ...
    return UIComponent.extend("sap.ushell.components.visualizationOrganizer.Component", {
        ...
        open: function (oOpenBy, oVizInfo) {
            var oPopover = Core.byId("sapUshellVisualizationOrganizerPopover");
        ...
        _resetPopup: function (oEvent) {
            var oPopover = Core.byId("sapUshellVisualizationOrganizerPopover");
            var oPagesList = Core.byId("sapUshellVisualizationOrganizerSpacesList");
            var oSearchField = Core.byId("sapUshellVisualizationOrganizerSearch");
            var oToggleButton = Core.byId("sapUshellVisualizationOrganizerSelectedPages");
        ...
        _onSearch: function (oEvent) {
            var oSelectedPagesButton = Core.byId("sapUshellVisualizationOrganizerSelectedPages");
