...
sap.ui.define([
    ...
    function LaunchPage (oAdapter/*, oContainerInterface*/) {
         ...
         * @public
         * @alias sap.ushell.services.LaunchPage#getCatalogTileTechnicalAttributes
         */
        ...
        this.changeURLStatesToPersistent = function (sURL) {
            ...
            sap.ushell.Container.getServiceAsync("AppState")
                .then(function (AppStateService) {
                    var bAppStateConfigPersistent = AppStateService.getPersistentWhenShared();
                    ...
                    if (AppStateService.getSupportedPersistencyMethods().length === 0 && bAppStateConfigPersistent !== true) {
