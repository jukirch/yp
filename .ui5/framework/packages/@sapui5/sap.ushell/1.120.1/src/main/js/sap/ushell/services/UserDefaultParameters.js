...
sap.ui.define([
     ...
     * <code>sap.ushell.Container.getServiceAsync("UserDefaultParameters")</code>. For details, see
    ...
    function UserDefaultParameters (oAdapter, oContainerInterface, sParameter, oConfig) {
        ...
        */
        this._insertPluginOrdered = function (aPlugins, oPlugin) {
            ...
            for (var i = 0; (i < aPlugins.length) && oPlugin; ++i) {
                var prioNth = getPrio(aPlugins[i]);
        ...
        this._iterateOverPluginsToGetDefaultValue = function (sParameterName, oStartValue, oSystemContext) {
            ...
            return new Promise(function (resolve, reject) {
                sap.ushell.Container.getServiceAsync("PluginManager").then(function (oPluginManagerService) {
        ...
        /**
         * given
         * @param {object} oDeferred a jQuery Deferred, which is to be resolved if the execution succeeded
        ...
        this._getEditorDataAndValue = function (oDeferred, aAllParameterNames, aExtendedParameterNames, oMetadataObject, oSystemContext) {
            ...
            jQuery.when.apply(jQuery, aDeferreds).done(function () {
                ...
                that._addParameterValuesToParameters(oParametersWithMetadata, aAllParameterNames, oSystemContext).done(function (oParameters) {
                    ...
                    var aKeys = Object.keys(oParametersDeepCopy).splice(0);
