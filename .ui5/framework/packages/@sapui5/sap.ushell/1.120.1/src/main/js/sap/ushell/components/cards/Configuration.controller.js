...
], function (manifestPropertyHelper, resources, Controller, formatter, JSONModel, jQuery, Log, Configuration) {
    "use strict";
    ...
    return Controller.extend("sap.ushell.components.cards.Configuration", {
        ...
        _getLanguages: function () {
            ...
            return {
                ...
                logonLanguage: Configuration.getLocale().getSAPLogonLanguage(),
