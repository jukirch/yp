...
sap.ui.define([
    ...
    function migrateV2ServiceConfig (ushellConfig) {
        ...
        [
            ...
            {from: "services.Notification", to: "services.NotificationV2"},
            ...
            if (oConfigFrom && !oConfigTo) {
                ...
                ObjectPath.set(oMigration.to, oConfigFrom, ushellConfig);
            }
        });
    }
    ...
    return {
        ...
        migrateV2ServiceConfig: migrateV2ServiceConfig
    };
});
