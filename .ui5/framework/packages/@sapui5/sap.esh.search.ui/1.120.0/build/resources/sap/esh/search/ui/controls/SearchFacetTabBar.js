...
(function(){
sap.ui.define(["../i18n", "sap/base/Log", "sap/m/Button", "sap/m/Title", "sap/m/List", "sap/m/CustomListItem", "sap/m/Toolbar", "sap/m/ToolbarSpacer", "sap/m/ActionSheet", "sap/m/Link", "sap/m/Label", "sap/m/VBox", "sap/m/library", "sap/ui/core/Control", "./SearchFacetDialog", "./SearchGroupHeaderListItem", "./SearchFacet", "./SearchFacetPieChart", "./SearchFacetBarChart", "../SearchFacetDialogModel", "../eventlogging/UserEvents"], function (__i18n, Log, Button, Title, List, CustomListItem, Toolbar, ToolbarSpacer, ActionSheet, Link, Label, VBox, sap_m_library, Control, __SearchFacetDialog, __SearchGroupHeaderListItem, __SearchFacet, __SearchFacetPieChart, __SearchFacetBarChart, __SearchFacetDialogModel, ___eventlogging_UserEvents) {
