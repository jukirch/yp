...
(function(){
sap.ui.define(["../i18n", "sap/esh/search/ui/controls/SearchFacetItem", "sap/m/List", "sap/m/library", "../eventlogging/UserEvents", "../error/errors"], function (__i18n, SearchFacetItem, List, sap_m_library, ___eventlogging_UserEvents, __errors) {
        ...
        case "attribute":
          {
            ...
            if (oModel.config && typeof oModel.config.getSearchInFacetListMode === "function") {
              ...
              try {
                ...
                var oError = new errors.ConfigurationExitError("getSearchInFacetListMode", oModel.config.applicationComponent, err);
                throw oError;
              }
            }
