...
sap.ui.define(["sap/m/List", "sap/m/GroupHeaderListItem", "sap/m/CustomListItem", "./SearchFacetHierarchyStaticTreeItem", "sap/m/Label", "sap/m/library", "sap/ui/core/Icon", "sap/m/FlexBox", "../tree/TreeView", "sap/m/FlexItemData", "../error/errors"], function (List, GroupHeaderListItem, CustomListItem, __SearchFacetHierarchyStaticTreeItem, Label, sap_m_library, Icon, FlexBox, __TreeView, FlexItemData, __errors) {
  ...
  var SearchFacetHierarchyStatic = /*#__PURE__*/function (_List) {
    ...
    function SearchFacetHierarchyStatic(sId, options) {
      ...
      _this.bindProperty("visible", {
        parts: [{
          path: "rootTreeNode/childTreeNodes/length"
        }],
        formatter: function formatter() {
          var _facet$rootTreeNode;
          var facet = _this.getBindingContext().getObject();
          var childTreeNodes = facet === null || facet === void 0 ? void 0 : (_facet$rootTreeNode = facet.rootTreeNode) === null || _facet$rootTreeNode === void 0 ? void 0 : _facet$rootTreeNode.childTreeNodes;
          if (!childTreeNodes) {
            return false;
          }
          var realTreeNodes = childTreeNodes.filter(function (treeNode) {
    ...
    _createClass(SearchFacetHierarchyStatic, [{
      ...
      value: function onAfterRendering(oEvent) {
        _get(_getPrototypeOf(SearchFacetHierarchyStatic.prototype), "onAfterRendering", this).call(this, oEvent);
        ...
        if (oModel.config.searchInAreaOverwriteMode && typeof oModel.config.setQuickSelectDataSourceAllAppearsNotSelected === "function") {
          try {
            ...
            var oError = new errors.ConfigurationExitError("setQuickSelectDataSourceAllAppearsNotSelected", oModel.config.applicationComponent, err);
            throw oError;
          }
        }
      }
