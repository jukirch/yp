...
(function(){
sap.ui.define(["./i18n", "sap/esh/search/ui/controls/SearchFieldGroup", "sap/esh/search/ui/SearchHelper", "sap/ui/core/InvisibleText", "sap/esh/search/ui/SearchModel", "./SearchFieldStateManager", "./SearchShellHelperHorizonTheme", "./UIEvents"], function (__i18n, SearchFieldGroup, SearchHelper, InvisibleText, SearchModel, __SearchFieldStateManager, __SearchShellHelperHorizonTheme, __UIEvents) {
  ...
  var SearchShellHelper = /*#__PURE__*/function () {
    ...
    _createClass(SearchShellHelper, null, [{
      ...
      value: function init() {
        ...
        window.sap.ushell.Container.getServiceAsync("Search").then(function (service) {
          service.prefetch();
        });
