...
sap.ui.define(["./i18n", "sap/base/Log", "./error/ErrorHandler", "sap/esh/search/ui/SearchHelper", "sap/ui/model/json/JSONModel", "sap/esh/search/ui/SearchResultFormatter", "sap/esh/search/ui/SearchTabStripsFormatter", "sap/esh/search/ui/SearchResultTableFormatter", "sap/esh/search/ui/SearchFacetsFormatter", "sap/esh/search/ui/BreadcrumbsFormatter", "sap/esh/search/ui/suggestions/SuggestionHandler", "sap/esh/search/ui/SearchConfiguration", "sap/esh/search/ui/personalization/PersonalizationStorage", "sap/esh/search/ui/personalization/keyValueStoreFactory", "sap/esh/search/ui/eventlogging/EventLogger", "sap/esh/search/ui/SearchUrlParser", "sap/esh/search/ui/cFLPUtil", "sap/esh/search/ui/usercategories/UserCategoryManager", "sap/esh/search/ui/error/errors", "sap/esh/search/ui/RecentlyUsedStorage", "./eventlogging/UserEvents", "./sinaNexTS/sina/SinaConfiguration", "./sinaNexTS/sina/sinaFactory", "./sinaNexTS/core/Log", "./SearchResultItemMemory", "./FolderModeUtils", "sap/ui/core/library", "./sinaNexTS/sina/HierarchyDisplayType", "./UIEvents", "./SearchShellHelperHorizonTheme", "./SearchConfigurationSettings", "./BusyIndicator", "./SinaConfigurator"], function (__i18n, Log, __ErrorHandler, SearchHelper, JSONModel, SearchResultFormatter, sap_esh_search_ui_SearchTabStripsFormatter, SearchResultTableFormatter, SearchFacetsFormatter, BreadcrumbsFormatter, SuggestionHandler, SearchConfiguration, PersonalizationStorage, keyValueStoreFactory, EventLogger, SearchUrlParser, cFLPUtil, UserCategoryManager, errors, RecentlyUsedStorage, ___eventlogging_UserEvents, ___sinaNexTS_sina_SinaConfiguration, sinaFactory, ___sinaNexTS_core_Log, __SearchResultSetItemMemory, ___FolderModeUtils, sap_ui_core_library, ___sinaNexTS_sina_HierarchyDisplayType, __UIEvents, __SearchShellHelperHorizonTheme, ___SearchConfigurationSettings, ___BusyIndicator, ___SinaConfigurator) {
  ...
  var SinaConfigurator = ___SinaConfigurator["SinaConfigurator"]; // declare global {
  //     interface Window {
  //         sap: {
  //             base: {
  //                 i18n: {
  ...
  var SearchModel = JSONModel.extend("sap.esh.search.ui.SearchModel", {
      ...
      try {
        ...
        return _await(_continue(_catch(function () {
          ...
          return _await(keyValueStoreFactory.create(_this7.config.personalizationStorage, _this7.config.isUshell, _this7.config.id), function (keyValueStore) {
            _this7.setPersonalizationStorageInstance(new PersonalizationStorage(keyValueStore, _this7));
            ...
            return _await(_this7.createSina(), function (_this7$createSina) {
              ...
              _this7.sinaNext.createSearchNavigationTarget = _this7.createSearchNavigationTarget.bind(_this7);
              ...
              return _invoke(function () {
                ...
                var loggerProperties = {
                  ...
                  searchModel: _this7,
                  eventConsumers: _this7.config.eventConsumers
                };
                _this7.eventLogger = new EventLogger(loggerProperties);
                return _await(_this7.eventLogger.initAsync(), function () {
                  ...
                  if (_this7.sinaNext.provider.id === "inav2" && _this7.config.isUshell) {
                    ...
                    sap.ui.require(["sap/ushell/System"], function (SystemConstructionFunction) {
                  ...
                  return _continue(_catch(function () {
                    ...
                    return _invokeIgnored(function () {
                      if ((_window$sap = window.sap) !== null && _window$sap !== void 0 && (_window$sap$ushell = _window$sap.ushell) !== null && _window$sap$ushell !== void 0 && _window$sap$ushell.Container) {
                        return _await(window.sap.ushell.Container.getServiceAsync("VisualizationInstantiation"), function (_window$sap$ushell$Co) {
                          _this7.uShellVisualizationInstantiationService = _window$sap$ushell$Co;
                        });
                      }
    ...
    createSina: function _createSina() {
      try {
        ...
        return _await(cFLPUtil.readCFlpConfiguration(trials), function (_cFLPUtil$readCFlpCon) {
          ...
          var sinaConfigurator = new SinaConfigurator(_this8);
    ...
    _calculateCountText: function _calculateCountText() {
      ...
      var text = i18n.getText("results") + " (" + countAsStr + ")"; // ToDo: RTL
      return text;
    },
    ...
    getUserCategoryManager: function _getUserCategoryManager() {
      try {
        ...
        _this10._userCategoryManagerPromise = _this10.initAsync().then(function () {
          return _this.userCategoryManager;
        });
        return _await(_this10._userCategoryManagerPromise);
      } catch (e) {
        return Promise.reject(e);
    ...
    _doFirePerspectiveQuery: function _doFirePerspectiveQuery(deserializationIn, preserveFormerResultsIn) {
      ...
      // set ESH GPT service flag (eshGpt)
      if ((_this$config = this.config) !== null && _this$config !== void 0 && _this$config.useEshGpt) {
        this.query.setEshGpt(true);
      }
      ...
      return Promise.all([this.normalSearch(preserveFormerResults), this.appSearch()]).then(function () {
        var _this2$_perspective;
        _this2.calculateResultViewSwitchVisibility();
        _this2.setProperty("/tabStrips", _this2._tabStripFormatter.format(_this2.getDataSource(), _this2._perspective, _this2));
        _this2.setProperty("/breadcrumbsHierarchyNodePaths", _this2._breadcrumbsFormatter.formatNodePaths(_this2._perspective));
        _this2.setProperty("/breadcrumbsHierarchyAttribute", _this2._breadcrumbsFormatter.formatHierarchyAttribute(_this2._perspective));
        _this2.setProperty("/hierarchyNodePaths", (_this2$_perspective = _this2._perspective) === null || _this2$_perspective === void 0 ? void 0 : _this2$_perspective.hierarchyNodePaths);
        _this2.setProperty("/isFolderMode", _this2.getProperty("/uiFilter").isFolderMode());
        if (_this2.config.bRecentSearches && _this2.recentlyUsedStorage) {
          _this2.recentlyUsedStorage.addItem();
        }
        return _this2.oFacetFormatter.getFacets(_this2.getDataSource(), _this2._perspective, _this2)["catch"](function (error) {
          var _iterator5 = _createForOfIteratorHelper(_this2._performanceLoggerSearchMethods),
            _step5;
          try {
            for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
              var _method = _step5.value;
              _this2.config.performanceLogger.leaveMethod({
                name: _method
              });
            }
          } catch (err) {
          ...
          _this2._performanceLoggerSearchMethods = [];
          return _this2._errorHandler.onErrorDeferred(error);
          ...
          if ((facets === null || facets === void 0 ? void 0 : facets.length) > 0) {
            ...
            _this2.setProperty("/facets", facets);
        ...
        var _iterator6 = _createForOfIteratorHelper(_this2._performanceLoggerSearchMethods),
          _step6;
        try {
        ...
        try {
          if (_this2.config && _this2.config.overwriteBrowserTitle === true) {
            document.title = _this2.getDocumentTitle();
          }
          var _iterator7 = _createForOfIteratorHelper(_this2._performanceLoggerSearchMethods),
            _step7;
          try {
          ...
          _this2._performanceLoggerSearchMethods = [];
          _this2.notifySubscribers(UIEvents.ESHSearchFinished);
          sap.ui.getCore().getEventBus().publish(UIEvents.ESHSearchFinished);
          _this2.busyIndicator.setBusy(false);
          _this2.setProperty("/firstSearchWasExecuted", true);
          _this2.notifyFilterChanged();
          _this2.updateMultiSelectionSelected();
        } catch (error) {
          _this2._errorHandler.onError(error);
        }
      });
    },
    ...
    appSearch: function _appSearch() {
      ...
      return this._searchApplicationsRefuseOutdatedReq(this.query.filter.searchTerm, top, 0).then(function (oResult) {
        ...
        _this3.setProperty("/appCount", oResult.totalResults);
        _this3.setProperty("/appResults", oResult.getElements());
      }, function (error) {
    ...
    normalSearch: function _normalSearch(preserveFormerResults) {
      ...
      var successHandler = function successHandler(searchResultSet) {
        _this4._perspective = searchResultSet; // TODO: sinaNext: rename perspective to resultSet
        _this4.setProperty("/nlqSuccess", false);
        if (searchResultSet.nlqSuccess) {
          _this4.setProperty("/nlqSuccess", true);
          _this4.setProperty("/nlqDescription", searchResultSet.title);
        }
        return _this4._afterSearchPrepareResultList(_this4._perspective);
      };
    ...
    _afterSearchPrepareResultList: function _afterSearchPrepareResultList(searchResultSet) {
      ...
      var thisPromise = Promise.all([Promise.resolve(searchResultSet), loadCustomModulesProm]).then(function (params) {
        ...
        // DWC exit
        if (_this5.config && typeof _this5.config.setSearchInLabelIconBindings === "function") {
          try {
            _this5.config.setSearchInLabelIconBindings(_this5, searchResultSet.facets);
          } catch (err) {
            var oError = new errors.ConfigurationExitError("setSearchInLabelIconBindings", _this5.config.applicationComponent, err);
            throw oError;
          }
        }
        _this5.setProperty("/boCount", searchResultSet.totalCount);
        _this5.setProperty("/boResults", newResults);
        _this5.enableOrDisableMultiSelection();
        return Promise.resolve();
      });
      return thisPromise;
    },
    ...
    calculatePlaceholder: function _calculatePlaceholder() {
      ...
      if (this.isAllCategory() || ((_this$config2 = this.config) === null || _this$config2 === void 0 ? void 0 : _this$config2.bPlaceHolderFixedValue) === true) {
        return i18n.getText("search");
      } else if (typeof ((_this$config3 = this.config) === null || _this$config3 === void 0 ? void 0 : _this$config3.getSearchInputPlaceholderLabel) === "function") {
        try {
          var _this$config4;
          dataSourceLabel = (_this$config4 = this.config) === null || _this$config4 === void 0 ? void 0 : _this$config4.getSearchInputPlaceholderLabel(this.getProperty("/uiFilter"));
        } catch (err) {
          var oError = new errors.ConfigurationExitError("getSearchInputPlaceholderLabel", this.config.applicationComponent, err);
          // not significant, unnecessary to throw exception, display fallback placeholder text
          this._errorHandler.onError(oError);
        }
      }
      // robustness
    ...
    createSearchNavigationTarget: function _createSearchNavigationTarget(filter, label) {
      var _this6 = this;
      var navTarget;
      if (this.config.updateUrl === true) {
        var top = this.config.pageSize || 10;
        var url = this.searchUrlParser.renderFromParameters(top, filter, true);
        navTarget = this.sinaNext._createNavigationTarget({
          targetUrl: url,
          text: label,
          target: "_self"
        });
