...
(function(){
sap.ui.define(["../i18n", "sap/esh/search/ui/controls/SearchText", "sap/esh/search/ui/SearchHelper", "sap/esh/search/ui/controls/SearchRelatedObjectsToolbar", "sap/m/Button", "sap/m/library", "sap/m/Label", "sap/m/Text", "sap/m/CheckBox", "sap/ui/core/Icon", "sap/ui/core/IconPool", "sap/ui/core/InvisibleText", "sap/ui/core/Control", "../eventlogging/UserEvents", "../UIUtil", "./SearchLink", "../sinaNexTS/sina/NavigationTarget"], function (__i18n, SearchText, SearchHelper, SearchRelatedObjectsToolbar, Button, sap_m_library, Label, Text, CheckBox, Icon, IconPool, InvisibleText, Control, ___eventlogging_UserEvents, ___UIUtil, __SearchLink, ___sinaNexTS_sina_NavigationTarget) {
  ...
  var SearchResultListItem = Control.extend("sap.esh.search.ui.controls.SearchResultListItem", {
    ...
    constructor: function _constructor(sId, settings) {
      ...
      this.setAggregation("_titleLink", new SearchLink("".concat(this.getId(), "--titleLink")).addStyleClass("sapUshellSearchResultListItem-HeaderEntry").addStyleClass("sapUshellSearchResultListItem-Title").addStyleClass("sapUshellSearchResultListItem-MightOverflow")
      // .attachPress((oEvent: Event) => {
      //     const phoneSize = this._getPhoneSize();
      ...
      //         };
      //     }
      //     this._performTitleNavigation(navigationOptions);
      // })
      );
    ...
    _renderTitleContainer: function _renderTitleContainer(oRm, oControl) {
      ...
      if (!titleText || titleText.trim().length === 0) {
        ...
        titleLink.setNavigationTarget(titleNavigation);
        if (this.isHierarchyItem()) {
          setTimeout(function () {
            if (_this3.supportsDragAndDrop(titleLink, oModel)) {
              // no drag&drop of title link (<a>-tag)
              titleLink.getDomRef()["draggable"] = false;
              _this3.addStyleClass("sapUshellSearchResultListItem-NotDraggableNotClickable");
            }
          }, 100);
      ...
      if (this.getProperty("titleIconUrl")) {
        ...
        oIcon === null || oIcon === void 0 ? void 0 : oIcon.addStyleClass("sapUshellSearchResultListItem-Clickable");
        titleLink.setAggregation("icon", oIcon);
        setTimeout(function () {
          if (!_this3.isHierarchyItem() && _this3.supportsDragAndDrop(titleLink, oModel)) {
            var domElement = oIcon === null || oIcon === void 0 ? void 0 : oIcon.getDomRef();
            if (domElement) {
      ...
      if (oModel.config.optimizeForValueHelp) {
        ...
        if (oModel.getDataSource() === this.getProperty("dataSource")) {
          ...
          var navigationTarget = oModel.createSearchNavigationTarget(uiFilterClone, this.getProperty("type"));
    ...
    _renderCheckbox: function _renderCheckbox(oRm) {
      ...
      // const selectEnabled = this.getProperty("selectEnabled");
      checkbox.setSelected(selected);
      // checkbox.setEnabled(selectEnabled);
    ...
    _renderImageForDocument: function _renderImageForDocument(oRm) {
      if (this.getProperty("imageFormat") && this.getProperty("imageFormat").toLowerCase() === "documentthumbnail") {
        ...
        var imageNavigationUrl = imageNavigation ? imageNavigation.targetUrl : "";
    ...
    _renderAllAttributes: function _renderAllAttributes(oRm, itemAttributes) {
      ...
      for (i = 0; !(additionalWhyFoundAttributesDesktop <= 0 && additionalWhyFoundAttributesTablet <= 0) && i < itemAttributes.length; i++) {
        ...
        this.adjustCssDragAndDrop(label, _oModel);
        ...
        if (itemAttribute.defaultNavigationTarget instanceof NavigationTarget) {
          var navigationTarget = itemAttribute.defaultNavigationTarget;
          value = new SearchLink("".concat(this.getId(), "--attr").concat(i, "_defNavTarget_Link"), {
            navigationTarget: null,
            wrapping: false,
            tooltip: itemAttribute.tooltip || ""
          });
        ...
        this.adjustCssDragAndDrop(value, _oModel);
    ...
    _registerItemPressHandler: function _registerItemPressHandler() {
      ...
      var parentListItem = this.getProperty("parentListItem");
      if (parentListItem) {
        parentListItem.attachPress(function (oEvent) {
