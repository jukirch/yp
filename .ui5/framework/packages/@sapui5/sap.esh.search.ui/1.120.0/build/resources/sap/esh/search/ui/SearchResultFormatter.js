    ...
    _createClass(SearchResultFormatter, [{
      ...
      value: function format(searchResultSet, terms, options) {
        ...
        for (var i = 0; i < resultItems.length; i++) {
          ...
          var itemHierarchyNodePaths = resultItem.hierarchyNodePaths;
      ...
      value: function _formatAttributeGroup(attributeGroup, options, index) {
        var _parentAttribute2, _childAttribute2;
        ...
        if (!(attributeGroupAsAttribute.defaultNavigationTarget instanceof NavigationTarget)) {
          var _parentAttribute, _childAttribute;
          if (((_parentAttribute = parentAttribute) === null || _parentAttribute === void 0 ? void 0 : _parentAttribute.defaultNavigationTarget) instanceof NavigationTarget) {
            attributeGroupAsAttribute.defaultNavigationTarget = parentAttribute.defaultNavigationTarget;
          } else if (((_childAttribute = childAttribute) === null || _childAttribute === void 0 ? void 0 : _childAttribute.defaultNavigationTarget) instanceof NavigationTarget) {
            attributeGroupAsAttribute.defaultNavigationTarget = childAttribute.defaultNavigationTarget;
          }
        }
        if ((_parentAttribute2 = parentAttribute) !== null && _parentAttribute2 !== void 0 && _parentAttribute2.tooltip) {
          attributeGroupAsAttribute.tooltip = parentAttribute.tooltip;
        } else if ((_childAttribute2 = childAttribute) !== null && _childAttribute2 !== void 0 && _childAttribute2.tooltip) {
          attributeGroupAsAttribute.tooltip = childAttribute.tooltip;
        }
        if (!attributeGroupAsAttribute.iconUrl) {
          var _parentAttribute3, _childAttribute3;
          if ((_parentAttribute3 = parentAttribute) !== null && _parentAttribute3 !== void 0 && _parentAttribute3.iconUrl) {
            attributeGroupAsAttribute.iconUrl = parentAttribute.iconUrl;
          } else if ((_childAttribute3 = childAttribute) !== null && _childAttribute3 !== void 0 && _childAttribute3.iconUrl) {
      ...
      value: function _formatResultForDocuments(resultItem, additionalParameters) {
        ...
        if (additionalParameters.isDocumentConnector === true) {
          ...
          var navigationTarget = this.model.sinaNext._createNavigationTarget(navOptions);
