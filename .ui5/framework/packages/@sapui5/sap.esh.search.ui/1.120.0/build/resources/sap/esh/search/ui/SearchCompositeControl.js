...
sap.ui.define(["./error/ErrorHandler", "./i18n", "sap/ui/model/resource/ResourceModel", "sap/esh/search/ui/controls/SearchFieldGroup", "sap/esh/search/ui/SearchModel", "sap/esh/search/ui/controls/SearchLayoutResponsive", "sap/esh/search/ui/controls/SearchResultContainer", "sap/esh/search/ui/controls/SearchResultList", "sap/esh/search/ui/controls/SearchResultTable", "sap/esh/search/ui/controls/SearchResultGrid", "sap/esh/search/ui/controls/SearchSpreadsheet", "sap/esh/search/ui/controls/SearchText", "sap/esh/search/ui/controls/SearchCountBreadcrumbs", "sap/esh/search/ui/controls/SearchResultListItem", "sap/esh/search/ui/controls/CustomSearchResultListItem", "sap/esh/search/ui/controls/SearchTileHighlighter", "sap/esh/search/ui/controls/SearchFilterBar", "sap/esh/search/ui/controls/SearchFacetFilter", "sap/esh/search/ui/SearchHelper", "sap/ui/core/Control", "sap/ui/core/InvisibleText", "sap/ui/core/Icon", "sap/ui/core/IconPool", "sap/ui/layout/VerticalLayout", "sap/ui/model/BindingMode", "sap/m/Button", "sap/m/OverflowToolbarButton", "sap/m/library", "sap/m/SegmentedButton", "sap/m/SegmentedButtonItem", "sap/m/ToggleButton", "sap/m/Bar", "sap/m/IconTabBar", "sap/m/IconTabFilter", "sap/m/OverflowToolbarLayoutData", "sap/m/OverflowToolbar", "sap/m/ToolbarSeparator", "sap/m/Label", "sap/m/Text", "sap/m/Dialog", "sap/m/Column", "sap/m/ColumnListItem", "sap/m/CustomListItem", "sap/m/ActionSheet", "sap/m/FlexBox", "sap/m/GenericTile", "sap/m/TileContent", "sap/m/ViewSettingsDialog", "sap/m/ViewSettingsItem", "sap/m/MessagePopover", "sap/m/MessageItem", "sap/m/HBox", "sap/m/VBox", "sap/f/GridContainer", "sap/f/GridContainerSettings", "sap/f/GridContainerItemLayoutData", "./error/errors", "./eventlogging/UserEvents", "sap/m/IllustratedMessage", "sap/m/IllustratedMessageType", "sap/m/IllustratedMessageSize", "sap/esh/search/ui/error/errors", "sap/ui/core/ResizeHandler", "./controls/OpenShowMoreDialog", "sap/m/ToolbarSpacer", "./UIEvents", "./SearchResultTablePersonalizer", "sap/ushell/ui/footerbar/AddBookmarkButton", "./sinaNexTS/sina/NavigationTarget", "./sinaNexTS/sina/cloneUtil", "./controls/SearchLink", "./controls/SearchQueryExplanation"], function (__ErrorHandler, __i18n, ResourceModel, SearchFieldGroup, SearchModel, SearchLayoutResponsive, SearchResultContainer, SearchResultList, SearchResultTable, SearchResultGrid, SearchSpreadsheet, SearchText, SearchCountBreadcrumbs, SearchResultListItem, CustomSearchResultListItem, sap_esh_search_ui_controls_SearchTileHighlighter, SearchFilterBar, SearchFacetFilter, SearchHelper, Control, InvisibleText, Icon, IconPool, VerticalLayout, BindingMode, Button, OverflowToolbarButton, sap_m_library, SegmentedButton, SegmentedButtonItem, ToggleButton, Bar, IconTabBar, IconTabFilter, OverflowToolbarLayoutData, OverflowToolbar, ToolbarSeparator, Label, Text, Dialog, Column, ColumnListItem, CustomListItem, ActionSheet, FlexBox, GenericTile, TileContent, ViewSettingsDialog, ViewSettingsItem, MessagePopover, MessageItem, HBox, VBox, GridContainer, GridContainerSettings, GridContainerItemLayoutData, ___error_errors, ___eventlogging_UserEvents, IllustratedMessage, IllustratedMessageType, IllustratedMessageSize, errors, ResizeHandler, ___controls_OpenShowMoreDialog, ToolbarSpacer, __UIEvents, __SearchResultTablePersonalizer, AddBookmarkButton, ___sinaNexTS_sina_NavigationTarget, ___sinaNexTS_sina_cloneUtil, __SearchLink, __SearchQueryExplanation) {
  ...
  var SearchResultTablePersonalizer = _interopRequireDefault(__SearchResultTablePersonalizer);
  var NavigationTarget = ___sinaNexTS_sina_NavigationTarget["NavigationTarget"];
  var clonePublic = ___sinaNexTS_sina_cloneUtil["clonePublic"];
  var BarDesign = sap_m_library["BarDesign"];
  var SearchLink = _interopRequireDefault(__SearchLink);
  var SearchQueryExplanation = _interopRequireDefault(__SearchQueryExplanation); // =============== WARNING ===============================================================
  ...
  var SearchCompositeControl = Control.extend("sap.esh.search.ui.SearchCompositeControl", {
    ...
    assembleGenericButtonsToolbar: function _assembleGenericButtonsToolbar() {
      ...
      var toolbarContent = [];
      // query information button (ESH GPT service / NLP)
      if (oModel !== null && oModel !== void 0 && (_oModel$config2 = oModel.config) !== null && _oModel$config2 !== void 0 && _oModel$config2.useEshGpt) {
        toolbarContent.push(this.assembleQueryInformationButton());
      }
      ...
      // share button
      var bWithShareButton = oModel === null || oModel === void 0 ? void 0 : (_oModel$config3 = oModel.config) === null || _oModel$config3 === void 0 ? void 0 : _oModel$config3.isUshell;
      if (bWithShareButton) {
      ...
      try {
        ...
        var customToolbarContent = oModel === null || oModel === void 0 ? void 0 : (_oModel$config4 = oModel.config) === null || _oModel$config4 === void 0 ? void 0 : _oModel$config4.getCustomToolbar();
    ...
    assembleQueryInformationButton: function _assembleQueryInformationButton() {
      var queryInformationButton = new OverflowToolbarButton((this.getId() ? this.getId() + "-" : "") + "queryExplanationButton", {
        icon: "sap-icon://information",
        tooltip: "{i18n>explainQueryBtn}",
        text: "{i18n>explainQueryBtn}",
        width: "auto",
        visible: {
          parts: [{
            path: "/nlqSuccess"
          }],
          formatter: function formatter(nlqSuccess) {
            return nlqSuccess;
          }
        },
        press: function press() {
      ...
      var dialog = new Dialog((this.getId() ? this.getId() + "-" : "") + "queryExplanationDialog", {
        contentHeight: "100%",
        contentWidth: "73%",
        resizable: true,
        draggable: true,
        title: "{i18n>explainQuery}",
        content: new SearchQueryExplanation((this.getId() ? this.getId() + "-" : "") + "queryExplanationDialogDetails", {
          // query: {},
          text: "{/nlqDescription}"
        }),
        beginButton: new Button((this.getId() ? this.getId() + "-" : "") + "queryExplanationDialogOkBtn", {
        ...
        endButton: new Button((this.getId() ? this.getId() + "-" : "") + "queryExplanationDialogCloseBtn", {
          text: "{i18n>closeBtn}",
          press: function press() {
            return dialog.close();
          }
      ...
      return queryInformationButton;
    },
    assembleShareButton: function _assembleShareButton() {
      var oModel = this.getModel();
      // bookmark button (entry in action sheet)
      var oBookmarkButton = new AddBookmarkButton((this.getId() ? this.getId() + "-" : "") + "bookmarkButton", {
        width: "auto",
    ...
    assembleDataSourceTabBar: function _assembleDataSourceTabBar() {
      var _this6 = this;
      var dataSourceTabBar = new IconTabBar("".concat(this.getId(), "-dataSourceTabBar"), {
    ...
    assembleSearchResultTable: function _assembleSearchResultTable(idPrefix) {
      ...
      resultTable.addStyleClass("sapElisa-search-result-table");
    ...
    assembleTableMainItems: function _assembleTableMainItems(oData, path) {
      ...
      columnListItem.bindAggregation("cells", {
        ...
        factory: function factory(subPath, bData) {
          ...
          if (bData.getObject().isRelatedApps) {
            ...
            for (var i = 0; i < navigationObjects.length; i++) {
              ...
              navigationButton = new Button("", {
                ...
                tooltip: navigationObject === null || navigationObject === void 0 ? void 0 : navigationObject.text
              });
          ...
          // cell with default navigation
          var navigationTarget = bData.getObject().defaultNavigationTarget;
          if (navigationTarget instanceof NavigationTarget) {
            var attributeLink = new SearchLink("", {
              navigationTarget: null,
              // text: bData.getObject().value,
              wrapping: true,
              tooltip: bData.getObject().tooltip || ""
              // target: navigationTarget.target || "_blank",
            });
            ...
            attributeLink.setText(bData.getObject().value);
            // for tooltip handling, see in SearchResultTable.onAfterRendering for event handlers
            attributeLink.addStyleClass("sapUshellSearchResultListItem-MightOverflow");
            var _oIcon = null;
            var iconSrc = bData.getObject().icon;
            if (typeof iconSrc === "string" && iconSrc.startsWith("sap-icon://")) {
              _oIcon = new Icon({
                src: iconSrc
              });
              _oIcon.addStyleClass("sapUshellSearchResultListItem-AttributeIcon");
              attributeLink.setAggregation("icon", _oIcon);
            }
    ...
    assembleResultListItem: function _assembleResultListItem(resultItemPath, oData) {
      ...
      var searchResultListItemSettings = {
        ...
        // selectEnabled: { path: "selectEnabled" },
        expanded: {
          path: "expanded"
        },
        positionInList: {
        ...
        formatter: function formatter(count, facetVisibility, rootCondition) {
          ...
          if (rootCondition && typeof oModel.config.isFilterBarVisible === "function") {
            try {
              ...
              var oError = new errors.ConfigurationExitError("isFilterBarVisible", oModel.config.applicationComponent, error);
              _this18.errorHandler.onError(oError);
            }
          }
          var searchBarVisible = count !== 0 || oModel.config.showSearchBarForNoResults;
    ...
    createNoResultScreen: function _createNoResultScreen(idPrefix, type) {
      ...
      if (type === "folder") {
        title = {
          ...
          formatter: function formatter(searchTerm) {
            return i18n.getText("no_results_info_1_folderEmpty", [searchTerm]);
          }
        };
      ...
      var noResultsScreenIdPrefix;
      if (type === "folder") {
        noResultsScreenIdPrefix = "".concat(idPrefix, "-searchContainerResultsView-noResultFolderScreen");
      } else {
        noResultsScreenIdPrefix = "".concat(idPrefix, "-searchContainerResultsView-noResultScreen");
      }
      var oIllustratedMessage = new IllustratedMessage("".concat(noResultsScreenIdPrefix, "-searchContainerResultsView-noResultScreen-illustratedMessage"), illustratedMessageSettings).addStyleClass("sapElisaNoResultScreen");
      oIllustratedMessage.addStyleClass("sapUiMediumMarginTop");
      var noResultScreen = new VBox("".concat(noResultsScreenIdPrefix, "-searchContainerResultsView-noResultScreen"), {
    ...
    createSearchContainer: function _createSearchContainer(idPrefix) {
        ...
        design: {
          ...
          formatter: function formatter(isFolderMode) {
            if (oModel.config.folderMode === true && isFolderMode === true) {
              _this19.oContextBar.addStyleClass("sapElisaSearchContextBarFolderMode");
            } else {
              _this19.oContextBar.removeStyleClass("sapElisaSearchContextBarFolderMode");
            }
      ...
      this.oSearchResultContainer = new SearchResultContainer("".concat(idPrefix, "-searchContainerResultsView"), {
        ...
        noResultScreen: this.createNoResultScreen(idPrefix, "default")
      });
    ...
    adjustSearchbarCustomGenericButtonWidth: function _adjustSearchbarCustomGenericButtonWidth() {
      ...
      if (this.oDataSourceTabBar.getVisible()) {
        var totalTextLength = this.oDataSourceTabBar.getItems().reduce(function (accumulator, item) {
          return accumulator + item["getText"]().length;
        }, 0);
      ...
      if (dataSourceTabBarWidthPx === 0) {
        if (genericToolbarWidthRem < 30) {
          this.oGenericItemsToolbar.setWidth("".concat(genericToolbarWidthRem - 1.1, "rem"));
        } else {
          this.oGenericItemsToolbar.setWidth("".concat(genericToolbarWidthRem - 3.0, "rem"));
        }
      } else {
    ...
    _resizeHandler: function _resizeHandler() {
      ...
      setTimeout(function () {
        return _this20.adjustSearchbarCustomGenericButtonWidth();
      }, 0);
    },
    ...
    createFooter: function _createFooter(idPrefix) {
      ...
      var oErrorButton = new Button(this.getId() + "-searchErrorButton", {
        ...
        press: function press() {
          if (_this21.oErrorPopover.isOpen()) {
            _this21.oErrorPopover.close();
          } else {
            _this21.oErrorPopover.setVisible(true);
            _this21.oErrorPopover.openBy(oErrorButton);
          }
        }
      });
    ...
    chooseNoResultScreen: function _chooseNoResultScreen() {
      ...
      var oModel = this.getModel();
      var noResultScreen;
      if (typeof (oModel === null || oModel === void 0 ? void 0 : (_oModel$config5 = oModel.config) === null || _oModel$config5 === void 0 ? void 0 : _oModel$config5.getCustomNoResultScreen) === "function") {
        try {
    ...
    getSearchResultSet: function _getSearchResultSet() {
      ...
      var searchModel = this.getModel();
      if (typeof searchModel["_perspective"] === "undefined" || searchModel["_perspective"] === null) {
        return {
          items: []
        };
      }
      // assemble result set
      var results = searchModel.getProperty("/results");
      var resultSet = {
        items: results.map(function (searchResultItem, index) {
          var resultSetItem = {
            data: clonePublic(searchResultItem.sinaItem),
            selected: searchResultItem.selected,
            setSelected: function setSelected(select) {
              searchModel.setProperty("/results/".concat(index, "/selected"), select);
            }
            /* enableSelection: (enable: boolean): void => {
                searchModel.setProperty(`/results/${resIndex}/selectEnabled`, enable);
            }, */
          };
    ...
    createContextBasedNavigationTarget: function _createContextBasedNavigationTarget(label, targetFunction) {
      var model = this.getModel();
      return model.sinaNext._createNavigationTarget({
        targetFunction: targetFunction,
        text: label
      });
    },
    addEventConsumer: function _addEventConsumer(eventConsumer) {
      var _model$eventLogger;
      var model = this.getModel();
      model === null || model === void 0 ? void 0 : (_model$eventLogger = model.eventLogger) === null || _model$eventLogger === void 0 ? void 0 : _model$eventLogger.addConsumer(eventConsumer);
    },
    getEventConsumers: function _getEventConsumers() {
      var _model$eventLogger2;
      var model = this.getModel();
      return model === null || model === void 0 ? void 0 : (_model$eventLogger2 = model.eventLogger) === null || _model$eventLogger2 === void 0 ? void 0 : _model$eventLogger2.consumers;
    },
    setEventConsumers: function _setEventConsumers(eventConsumers) {
      var _model$eventLogger3;
      var model = this.getModel();
      model === null || model === void 0 ? void 0 : (_model$eventLogger3 = model.eventLogger) === null || _model$eventLogger3 === void 0 ? void 0 : _model$eventLogger3.setConsumers(eventConsumers);
      return this;
    }
  });
