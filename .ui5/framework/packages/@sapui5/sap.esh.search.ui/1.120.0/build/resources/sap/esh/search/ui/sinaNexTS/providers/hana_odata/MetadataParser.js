    ...
    _createClass(MetadataParser, [{
      ...
      value: function fillPublicMetadataBuffer(dataSource, attributeMetadata, cdsAnnotations) {
        ...
        if (typeAndFormat && typeAndFormat.type) {
          ...
          if (attributeMetadata.hierarchyDefinition && (_attributeMetadata$hi3 = attributeMetadata.hierarchyDefinition) !== null && _attributeMetadata$hi3 !== void 0 && _attributeMetadata$hi3.isHierarchyDefinition) {
            var _attributeMetadata$hi4, _attributeMetadata$hi5, _attributeMetadata$hi6;
            dataSource.isHierarchyDataSource = true;
            dataSource.hierarchyName = (_attributeMetadata$hi4 = attributeMetadata.hierarchyDefinition) === null || _attributeMetadata$hi4 === void 0 ? void 0 : _attributeMetadata$hi4.name;
            dataSource.hierarchyAttribute = (_attributeMetadata$hi5 = attributeMetadata.hierarchyDefinition) === null || _attributeMetadata$hi5 === void 0 ? void 0 : _attributeMetadata$hi5.attributeName;
            dataSource.hierarchyDisplayType = (_attributeMetadata$hi6 = attributeMetadata.hierarchyDefinition) === null || _attributeMetadata$hi6 === void 0 ? void 0 : _attributeMetadata$hi6.displayType;
          }
