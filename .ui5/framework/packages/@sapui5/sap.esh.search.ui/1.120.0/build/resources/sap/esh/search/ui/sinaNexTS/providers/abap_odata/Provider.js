...
(function(){
sap.ui.define(["./ajax", "./ajaxTemplates", "./conditionSerializer", "../../core/core", "./dataSourceSerializer", "./labelCalculation", "./suggestionTermSplitter", "../AbstractProvider", "./FacetParser", "./ItemParser", "./NlqParser", "./EshGptParser", "./suggestionParser", "./MetadataParser", "../../core/errors"], function (___ajax, ajaxTemplates, conditionSerializer, core, dataSourceSerializer, labelCalculation, suggestionTermSplitter, ___AbstractProvider, ___FacetParser, ___ItemParser, ___NlqParser, ___EshGptParser, ___suggestionParser, ___MetadataParser, ____core_errors) {
  ...
  var EshGptParser = ___EshGptParser["EshGptParser"];
  ...
  var Provider = /*#__PURE__*/function (_AbstractProvider) {
    ...
    _createClass(Provider, [{
      ...
      value: function initAsync(configuration) {
        ...
        this.eshGptParser = new EshGptParser(this);
      ...
      key: "isCDSAnnotationSupported",
      value: function isCDSAnnotationSupported() {
        if (!this.serviceXML) {
          return false;
        }
        var annotationsQueryString = "Schema[Namespace='ESH_SEARCH_SRV']>EntityType[Name='DataSource'][*|content-version='1']>NavigationProperty[Name='Annotations']," + "Schema[Namespace='ESH_SEARCH_SRV']>EntityType[Name='DataSourceAttribute'][*|content-version='1']>NavigationProperty[Name='Annotations']";
      ...
      value: function executeSearchQuery(query) {
        ...
        if (query.eshGpt) {
          // no dedicated request template yet
        }
        ...
        return this.ajaxClient.postJson(requestUrl, requestTemplate).then(function (inputResponse) {
          ...
          var _response, _response$headers, _response2, _response2$headers;
          var nlqResult;
          var chatGptResponse = ((_response = response) === null || _response === void 0 ? void 0 : (_response$headers = _response.headers) === null || _response$headers === void 0 ? void 0 : _response$headers["Chatgptresponse"]) || ((_response2 = response) === null || _response2 === void 0 ? void 0 : (_response2$headers = _response2.headers) === null || _response2$headers === void 0 ? void 0 : _response2$headers["chatgptresponse"]);
          if (chatGptResponse) {
            // ESH GPT
            nlqResult = this.eshGptParser.parse(response);
          } else {
            // ABAP NLP
            nlqResult = this.nlqParser.parse(response.data.d);
          }
