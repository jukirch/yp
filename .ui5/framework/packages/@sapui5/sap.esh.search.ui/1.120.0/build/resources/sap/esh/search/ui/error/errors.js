...
sap.ui.define(["../i18n"], function (__i18n) {
  ...
  var ESHUIError = /*#__PURE__*/function (_Error) {
    ...
    function ESHUIError(propertiesOrMessage) {
      var _this;
      ...
      _this = _super.call(this, propertiesOrMessage.message);
      if (propertiesOrMessage.message) {
        _this.message = propertiesOrMessage.message;
      }
      if (propertiesOrMessage.previous) {
        _this.previous = propertiesOrMessage.previous;
      }
      _this.name = propertiesOrMessage.name || "ESHUIError";
      _this.solution = propertiesOrMessage.solution || i18n.getText("error.solution");
      return _this;
    }
  ...
  var AppSearchError = /*#__PURE__*/function (_ESHUIError6) {
    _inherits(AppSearchError, _ESHUIError6);
    var _super7 = _createSuper(AppSearchError);
    function AppSearchError(previousError, message) {
      _classCallCheck(this, AppSearchError);
      var name = "AppSearchError";
      var solution = i18n.getText("error.AppSearchError.solution");
    ...
    return _createClass(AppSearchError);
  }(ESHUIError);
  var module = {
