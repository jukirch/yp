...
sap.ui.define(["./SinaObject", "./DataSourceType", "./AttributeMetadata", "./AttributeGroupMetadata", "../core/errors", "./HierarchyDisplayType", "./MatchingStrategy", "./AttributeType"], function (___SinaObject, ___DataSourceType, ___AttributeMetadata, ___AttributeGroupMetadata, ___core_errors, ___HierarchyDisplayType, ___MatchingStrategy, ___AttributeType) {
  ...
  var DataSource = /*#__PURE__*/function (_SinaObject) {
    ...
    function DataSource(properties) {
      ...
      _this.isHierarchyDataSource = properties.isHierarchyDataSource;
    ...
    _createClass(DataSource, [{
      ...
      key: "getHierarchyDataSource",
      value: function getHierarchyDataSource() {
        if (this._hierarchyDataSource instanceof DataSource) {
          return this._hierarchyDataSource;
        }
        for (var i = 0; i < this.attributesMetadata.length; ++i) {
          var attributeMetadata = this.attributesMetadata[i];
      ...
      key: "getStaticHierarchyAttributeMetadata",
      value: function getStaticHierarchyAttributeMetadata() {
      ...
      key: "_getStaticHierarchyAttributeForDisplay",
      value: function _getStaticHierarchyAttributeForDisplay() {
        var _this$getHierarchyDat;
        ...
        var hierarchyAttributeId = this.hierarchyAttribute || ((_this$getHierarchyDat = this.getHierarchyDataSource()) === null || _this$getHierarchyDat === void 0 ? void 0 : _this$getHierarchyDat.hierarchyAttribute);
        ...
        for (var i = 0; i < this.attributeGroupsMetadata.length; i++) {
          var _attributeGroupMeta$_, _attributeGroupMeta$_2;
          var attributeGroupMeta = this.attributeGroupsMetadata[i];
          var parentAttribute = (_attributeGroupMeta$_ = attributeGroupMeta._private) === null || _attributeGroupMeta$_ === void 0 ? void 0 : _attributeGroupMeta$_.parentAttribute;
          if (parentAttribute instanceof AttributeMetadata && parentAttribute.id === hierarchyAttributeId && ((_attributeGroupMeta$_2 = attributeGroupMeta._private) === null || _attributeGroupMeta$_2 === void 0 ? void 0 : _attributeGroupMeta$_2.isDescription) === true) {
