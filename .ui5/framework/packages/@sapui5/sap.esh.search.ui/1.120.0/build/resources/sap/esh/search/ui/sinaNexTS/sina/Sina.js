  ...
  var Sina = /*#__PURE__*/function () {
    ...
    _createClass(Sina, [{
      ...
      value: function _createDataSourceResultSet(properties) {
        var filteredItems = this.removeHierarchyDataSources(properties.items, function (item) {
      ...
      key: "removeHierarchyDataSources",
      value: function removeHierarchyDataSources(list, getDataSource) {
        var _this = this;
      ...
      value: function getBusinessObjectDataSources() {
        ...
        return this.removeHierarchyDataSources(result, function (dataSource) {
          return dataSource;
        });
      }
    }, {
      ...
      key: "createStaticHierarchySearchNavigationTarget",
      value: function createStaticHierarchySearchNavigationTarget(hierarchyNodeId, hierarchyNodeLabel, dataSource, navigationTargetLabel, hierarchyNodeAttributeName) {
        if (!hierarchyNodeAttributeName) {
          hierarchyNodeAttributeName = dataSource.hierarchyAttribute;
          if (!hierarchyNodeAttributeName) {
            var helperHierarchyDataource = dataSource.getHierarchyDataSource();
      ...
      value: function getHierarchyDataSource(hierarchyName) {
