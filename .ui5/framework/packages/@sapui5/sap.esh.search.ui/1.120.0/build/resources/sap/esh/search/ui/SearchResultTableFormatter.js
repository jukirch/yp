...
(function(){
sap.ui.define(["./i18n", "./SearchResultBaseFormatter", "./SearchResultTableColumnType", "./SearchResultTablePersonalizer"], function (__i18n, __SearchResultBaseFormatter, ___SearchResultTableColumnType, ___SearchResultTablePersonalizer) {
  ...
  var TablePersoColumnIdPrefix = ___SearchResultTablePersonalizer["TablePersoColumnIdPrefix"];
      ...
      value: function formatColumns(results) {
        ...
        for (var i = 0; i < firstResult.itemattributes.length; i++) {
          ...
          columns.push({
            ...
            persoColumnId: TablePersoColumnIdPrefix.DETAIL + i,
        ...
        if (firstResult.titleDescription !== undefined) {
          column = {
            ...
            persoColumnId: TablePersoColumnIdPrefix.TITLE_DESCRIPTION,
        ...
        if (firstResult.title !== undefined) {
          ...
          if (typeof this.config.titleColumnName !== "undefined" && ((_this$config = this.config) === null || _this$config === void 0 ? void 0 : _this$config.titleColumnName) !== "") {
            column = {
              ...
              persoColumnId: TablePersoColumnIdPrefix.TITLE,
        ...
        if (firstResult.navigationObjects !== undefined && firstResult.navigationObjects.length > 0) {
          columns.push({
            ...
            persoColumnId: TablePersoColumnIdPrefix.RELATED_APPS,
        ...
        if (config !== null && config !== void 0 && (_config$extendTableCo = config.extendTableColumn) !== null && _config$extendTableCo !== void 0 && _config$extendTableCo.column) {
          column = {
            ...
            persoColumnId: TablePersoColumnIdPrefix.EXTEND,
