    ...
    handleSuggestionItemSelected: function _handleSuggestionItemSelected(oEvent) {
      ...
      switch (type) {
        case SuggestionType.Recent:
          if (suggestion.titleNavigation instanceof NavigationTarget) {
