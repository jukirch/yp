...
sap.ui.define(["./DataSource"], function (___DataSource) {
  ...
  var FilteredDataSource = /*#__PURE__*/function (_DataSource) {
    ...
    function FilteredDataSource(properties) {
      var _properties$annotatio, _properties$hidden, _properties$attribute, _properties$attribute2, _properties$attribute3, _properties$attribute4, _properties$isHierarc, _properties$hierarchy, _properties$hierarchy2, _properties$hierarchy3;
      var _this;
      ...
      properties.isHierarchyDataSource = (_properties$isHierarc = properties.isHierarchyDataSource) !== null && _properties$isHierarc !== void 0 ? _properties$isHierarc : properties.dataSource.isHierarchyDataSource;
