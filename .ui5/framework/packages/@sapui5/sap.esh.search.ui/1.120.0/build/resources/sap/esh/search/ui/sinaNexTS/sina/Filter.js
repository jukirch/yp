...
(function(){
sap.ui.define(["./SinaObject", "./SimpleCondition", "./ComplexCondition", "./LogicalOperator", "../core/errors", "./HierarchyDisplayType", "./DataSourceType"], function (___SinaObject, ___SimpleCondition, ___ComplexCondition, ___LogicalOperator, ___core_errors, ___HierarchyDisplayType, ___DataSourceType) {
  ...
  var Filter = /*#__PURE__*/function (_SinaObject) {
    ...
    _createClass(Filter, [{
      ...
      value: function isFolderMode() {
        ...
        var isHierarchyDataSource = this.dataSource.isHierarchyDataSource && this.dataSource.hierarchyDisplayType === HierarchyDisplayType.HierarchyResultView;
