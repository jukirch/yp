...
(function(){
sap.ui.define(["../i18n", "sap/esh/search/ui/SearchHelper", "sap/esh/search/ui/SearchFacetDialogHelper", "sap/esh/search/ui/SearchFacetDialogHelper_SearchAdvancedCondition_ModuleLoader", "sap/esh/search/ui/SearchFacetDialogHelperCharts", "sap/esh/search/ui/controls/SearchAdvancedCondition", "sap/esh/search/ui/FacetItem", "sap/m/library", "sap/m/Page", "sap/m/Dialog", "sap/m/Select", "sap/m/CheckBox", "sap/m/SearchField", "sap/m/ToggleButton", "sap/m/Button", "sap/m/StandardListItem", "sap/m/SplitContainer", "sap/ui/core/Item", "sap/m/List", "sap/m/HBox", "sap/m/VBox", "sap/ui/model/Filter", "sap/ui/model/FilterOperator", "sap/m/ScrollContainer", "sap/m/Toolbar", "sap/m/IconTabBar", "sap/m/IconTabFilter", "sap/ui/model/json/JSONModel", "sap/esh/search/ui/SearchModel", "../eventlogging/UserEvents", "../hierarchydynamic/SearchHierarchyDynamicFacet", "./SearchFacetHierarchyDynamic"], function (__i18n, SearchHelper, SearchFacetDialogHelper, SearchFacetDialogHelper_SearchAdvancedCondition_ModuleLoader, SearchFacetDialogHelperCharts, SearchAdvancedCondition, FacetItem, sap_m_library, Page, Dialog, Select, CheckBox, SearchField, ToggleButton, Button, StandardListItem, SplitContainer, Item, List, HBox, VBox, Filter, FilterOperator, ScrollContainer, Toolbar, IconTabBar, IconTabFilter, JSONModel, SearchModel, ___eventlogging_UserEvents, __SearchHierarchyDynamicFacet, __SearchFacetHierarchyDynamic) {
