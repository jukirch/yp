 ...
 */
sap.ui.define(["sap/base/security/encodeURL", "sap/m/Token", "sap/ui/core/CustomData", "sap/fe/navigation/SelectionVariant"], function (encodeURL, Token, CustomData, SelectionVariant) {
    "use strict";
        ...
        aSelctOptions.forEach(function (oSelectOption) {
            ...
            switch (oSelectOption.Option) {
                case "BT":
                    ...
                    break;
                case "CP":
                    if (oSelectOption.Low.match(/^[*]\\*(.*)\\*[*]$/)) {
                        oSelectOption.Low = oSelectOption.Low.slice(1, -1);
                    }
